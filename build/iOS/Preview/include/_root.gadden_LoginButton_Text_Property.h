...
namespace g{struct gadden_LoginButton_Text_Property;}
...
struct gadden_LoginButton_Text_Property : ::g::Uno::UX::Property1
{
    uWeak< ::g::LoginButton*> _obj;

    void ctor_3(::g::LoginButton* obj, ::g::Uno::UX::Selector name);
    static gadden_LoginButton_Text_Property* New1(::g::LoginButton* obj, ::g::Uno::UX::Selector name);
};
// }
