...
namespace g{struct gadden_accessor_LoginButton_Text;}
...
struct gadden_accessor_LoginButton_Text : ::g::Uno::UX::PropertyAccessor
{
    static ::g::Uno::UX::Selector _name_;
    static ::g::Uno::UX::Selector& _name() { return gadden_accessor_LoginButton_Text_typeof()->Init(), _name_; }
    static uSStrong< ::g::Uno::UX::PropertyAccessor*> Singleton_;
    static uSStrong< ::g::Uno::UX::PropertyAccessor*>& Singleton() { return gadden_accessor_LoginButton_Text_typeof()->Init(), Singleton_; }

    void ctor_1();
    static gadden_accessor_LoginButton_Text* New1();
};
// }
