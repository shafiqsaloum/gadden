#!/bin/bash
# This file was generated based on '/Users/ericaglimsholt/Library/Application Support/Fusetools/Packages/UnoCore/0.47.13/targets/ios/build.sh'.
...
##else
    xcodebuild -project "gadden.xcodeproj" "$@" | tee >(checkForError)
##endif
