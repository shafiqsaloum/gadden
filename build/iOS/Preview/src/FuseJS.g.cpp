...
// /Users/star-destryer/Library/Application Support/Fusetools/Packages/FuseJS/1.1.1/$.uno
// --------------------------------------------------------------------------------------
...
static void RaiseEvent_build(uType* type)
{
    ...
    ::STRINGS[60] = uString::Const("/Users/star-destryer/Library/Application Support/Fusetools/Packages/FuseJS/1.1.1/$.uno");
...
void RaiseEvent::Raise()
{
    ...
    if (dispatch == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::g::Uno::String::op_Addition2(::STRINGS[59/*"Cannot find...*/], Name), this, ::STRINGS[60/*"/Users/star...*/], 1045, ::STRINGS[61/*"Raise"*/], NULL);
        return;
    }
...
uObject* UserEvents::Raise(::g::Fuse::Scripting::Context* context, uArray* args)
{
    ...
    {
        ::g::Fuse::Diagnostics::Deprecated(::STRINGS[64/*"The FuseJS/...*/], context, ::STRINGS[60/*"/Users/star...*/], 1076, ::STRINGS[61/*"Raise"*/]);
