...
// public static extern class Support :513
// {
...
// public static extern Uno.Platform.iOS.uCGPoint CGPointFromUnoFloat2(float2 unoPoint, float scale) :632
...
// public static extern Uno.Platform.iOS.uCGPoint CGPointFromUnoInt2(int2 unoPoint, float scale) :624
...
// public static extern int2 CGPointToUnoInt2(Uno.Platform.iOS.uCGPoint point, float scale) :616
...
// public static extern Uno.Platform.iOS.uCGRect CGRectFromUnoRect(Uno.Rect unoRect, float scale) :640
...
// public static extern Uno.Platform.iOS.uCGRect CGRectFromUnoRecti(Uno.Recti unoRect, float scale) :650
...
// public static extern Uno.Recti CGRectToUnoRecti(Uno.Platform.iOS.uCGRect rect, float scale) :661
...
// public static extern Uno.Platform.iOS.uCGSize CGSizeFromUnoFloat2(float2 unoSize, float scale) :685
...
// public static extern Uno.Platform.iOS.uCGSize CGSizeFromUnoInt2(int2 unoSize, float scale) :677
...
// public static extern int2 CGSizeToUnoInt2(Uno.Platform.iOS.uCGSize size, float scale) :668
void Support__CGSizeToUnoInt2_fn(CGSize* size, float* scale, ::g::Uno::Int2* __retval)
{
    *__retval = Support::CGSizeToUnoInt2(*size, *scale);
}

// public static texture2D CreateTextureFromImage(Uno.Platform.iOS.UIImage image) :515
...
// private static int2 UIImageGetSize(Uno.Platform.iOS.UIImage image) :526
void Support__UIImageGetSize_fn(::UIImage ** image, ::g::Uno::Int2* __retval)
{
    *__retval = Support::UIImageGetSize(*image);
}

// private static byte[] UIImageToRGBA8888(Uno.Platform.iOS.UIImage _image) :536
void Support__UIImageToRGBA8888_fn(::UIImage ** _image, uArray** __retval)
{
    *__retval = Support::UIImageToRGBA8888(*_image);
}

// public static extern Uno.Platform.iOS.uCGPoint CGPointFromUnoFloat2(float2 unoPoint, float scale) [static] :632
...
// public static extern Uno.Platform.iOS.uCGPoint CGPointFromUnoInt2(int2 unoPoint, float scale) [static] :624
...
// public static extern int2 CGPointToUnoInt2(Uno.Platform.iOS.uCGPoint point, float scale) [static] :616
...
// public static extern Uno.Platform.iOS.uCGRect CGRectFromUnoRect(Uno.Rect unoRect, float scale) [static] :640
...
// public static extern Uno.Platform.iOS.uCGRect CGRectFromUnoRecti(Uno.Recti unoRect, float scale) [static] :650
...
// public static extern Uno.Recti CGRectToUnoRecti(Uno.Platform.iOS.uCGRect rect, float scale) [static] :661
...
// public static extern Uno.Platform.iOS.uCGSize CGSizeFromUnoFloat2(float2 unoSize, float scale) [static] :685
...
// public static extern Uno.Platform.iOS.uCGSize CGSizeFromUnoInt2(int2 unoSize, float scale) [static] :677
...
// public static extern int2 CGSizeToUnoInt2(Uno.Platform.iOS.uCGSize size, float scale) [static] :668
...
// public static texture2D CreateTextureFromImage(Uno.Platform.iOS.UIImage image) [static] :515
...
// private static int2 UIImageGetSize(Uno.Platform.iOS.UIImage image) [static] :526
...
// private static byte[] UIImageToRGBA8888(Uno.Platform.iOS.UIImage _image) [static] :536
