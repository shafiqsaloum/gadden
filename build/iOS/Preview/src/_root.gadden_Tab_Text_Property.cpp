...
// internal sealed class gadden_Tab_Text_Property :124
// {
...
// public gadden_Tab_Text_Property(Tab obj, Uno.UX.Selector name) :127
void gadden_Tab_Text_Property__ctor_3_fn(gadden_Tab_Text_Property* __this, ::g::Tab* obj, ::g::Uno::UX::Selector* name)
{
    __this->ctor_3(obj, *name);
}

// public override sealed string Get(Uno.UX.PropertyObject obj) :129
...
// public gadden_Tab_Text_Property New(Tab obj, Uno.UX.Selector name) :127
...
// public override sealed void Set(Uno.UX.PropertyObject obj, string v, Uno.UX.IPropertyListener origin) :130
...
// public override sealed bool get_SupportsOriginSetter() :131
void gadden_Tab_Text_Property__get_SupportsOriginSetter_fn(gadden_Tab_Text_Property* __this, bool* __retval)
{
    return *__retval = true, void();
}

// public gadden_Tab_Text_Property(Tab obj, Uno.UX.Selector name) [instance] :127
...
// public gadden_Tab_Text_Property New(Tab obj, Uno.UX.Selector name) [static] :127
