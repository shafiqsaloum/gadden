...
// internal sealed class gadden_Tab_Text_Property :89
// {
...
// public gadden_Tab_Text_Property(Tab obj, Uno.UX.Selector name) :92
void gadden_Tab_Text_Property__ctor_3_fn(gadden_Tab_Text_Property* __this, ::g::Tab* obj, ::g::Uno::UX::Selector* name)
{
    __this->ctor_3(obj, *name);
}

// public override sealed string Get(Uno.UX.PropertyObject obj) :94
...
// public gadden_Tab_Text_Property New(Tab obj, Uno.UX.Selector name) :92
...
// public override sealed void Set(Uno.UX.PropertyObject obj, string v, Uno.UX.IPropertyListener origin) :95
...
// public override sealed bool get_SupportsOriginSetter() :96
void gadden_Tab_Text_Property__get_SupportsOriginSetter_fn(gadden_Tab_Text_Property* __this, bool* __retval)
{
    return *__retval = true, void();
}

// public gadden_Tab_Text_Property(Tab obj, Uno.UX.Selector name) [instance] :92
...
// public gadden_Tab_Text_Property New(Tab obj, Uno.UX.Selector name) [static] :92
