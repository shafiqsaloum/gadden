...
// internal sealed class gadden_Tab_Text_Property :97
// {
...
// public gadden_Tab_Text_Property(Tab obj, Uno.UX.Selector name) :100
void gadden_Tab_Text_Property__ctor_3_fn(gadden_Tab_Text_Property* __this, ::g::Tab* obj, ::g::Uno::UX::Selector* name)
{
    __this->ctor_3(obj, *name);
}

// public override sealed string Get(Uno.UX.PropertyObject obj) :102
...
// public gadden_Tab_Text_Property New(Tab obj, Uno.UX.Selector name) :100
...
// public override sealed void Set(Uno.UX.PropertyObject obj, string v, Uno.UX.IPropertyListener origin) :103
...
// public gadden_Tab_Text_Property(Tab obj, Uno.UX.Selector name) [instance] :100
...
// public gadden_Tab_Text_Property New(Tab obj, Uno.UX.Selector name) [static] :100
