...
// public sealed extern class Slider :2025
// {
...
// private static float GetValue(ObjC.Object handle) :2079
void Slider__GetValue_fn(::g::ObjC::Object* handle, float* __retval)
{
    *__retval = Slider::GetValue(handle);
}

// public Slider New(Fuse.Controls.Native.IRangeViewHost host, Fuse.Visual visual) :2040
void Slider__New3_fn(uObject* host, ::g::Fuse::Visual* visual, Slider** __retval)
{
    *__retval = Slider::New3(host, visual);
}

// private void OnValueChanged(ObjC.Object sender, ObjC.Object uiEvent) :2067
...
// public void set_Progress(double value) :2030
void Slider__set_Progress_fn(Slider* __this, double* value)
{
    __this->Progress(*value);
}

// private static void SetValue(ObjC.Object handle, float value) :2086
void Slider__SetValue_fn(::g::ObjC::Object* handle, float* value)
{
    Slider::SetValue(handle, *value);
}

// private float get_Value() :2074
void Slider__get_Value_fn(Slider* __this, float* __retval)
{
    *__retval = __this->Value();
}

// private void set_Value(float value) :2075
void Slider__set_Value_fn(Slider* __this, float* value)
{
    __this->Value(*value);
}

// public Slider(Fuse.Controls.Native.IRangeViewHost host, Fuse.Visual visual) [instance] :2040
...
// private void OnValueChanged(ObjC.Object sender, ObjC.Object uiEvent) [instance] :2067
...
// public void set_Progress(double value) [instance] :2030
void Slider::Progress(double value)
{
    Value((float)value * 100.0f);
}

// private float get_Value() [instance] :2074
float Slider::Value()
{
    return Slider::GetValue(Handle());
}

// private void set_Value(float value) [instance] :2075
void Slider::Value(float value)
{
    Slider::SetValue(Handle(), value);
}

// private static ObjC.Object Create() [static] :2059
...
// private static float GetValue(ObjC.Object handle) [static] :2079
...
// public Slider New(Fuse.Controls.Native.IRangeViewHost host, Fuse.Visual visual) [static] :2040
...
// private static void SetValue(ObjC.Object handle, float value) [static] :2086
