// This file was generated based on '/Users/ericaglimsholt/Documents/Skola/Handels marketing/Gadden/gadden/build/iOS/Preview/cache/ux11/Hamburger.g.uno'.
...
// {
// static Hamburger() :26
static void Hamburger__cctor_4_fn(uType* __type)
{
}
...
static void Hamburger_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)Hamburger__New5_fn, 0, true, type, 0));
}
...
::g::Fuse::Controls::Control_type* Hamburger_typeof()
{
    ...
    type = (::g::Fuse::Controls::Control_type*)uClassType::New("Hamburger", options);
    type->fp_build_ = Hamburger_build;
    type->fp_ctor_ = (void*)Hamburger__New5_fn;
    type->fp_cctor_ = Hamburger__cctor_4_fn;
...
// public Hamburger New() :30
void Hamburger__New5_fn(Hamburger** __retval)
{
    *__retval = Hamburger::New5();
}

// public Hamburger() [instance] :30
...
void Hamburger::InitializeUX()
{
    ...
    Hamburger__Template* temp1 = Hamburger__Template::New2(this, this);
    ItemSpacing(3.0f);
    ContentAlignment(10);
    HitTestMode(2);
    ...
    temp->Count1(3);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp->Templates()), ::TYPES[0/*Uno.Collections.ICollection<Uno.UX.Template>*/]), temp1);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(Children()), ::TYPES[1/*Uno.Collections.ICollection<Fuse.Node>*/]), temp);
}

// public Hamburger New() [static] :30
Hamburger* Hamburger::New5()
{
