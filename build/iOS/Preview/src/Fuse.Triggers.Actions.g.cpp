...
// /Users/star-destryer/Library/Application Support/Fusetools/Packages/Fuse.Elements/1.1.1/triggers/actions/$.uno
// --------------------------------------------------------------------------------------------------------------
...
static void PlayTo_build(uType* type)
{
    ...
    ::STRINGS[8] = uString::Const("/Users/star-destryer/Library/Application Support/Fusetools/Packages/Fuse.Triggers/1.1.1/actions/$.uno");
...
{
    ctor_2();
    ::g::Fuse::Diagnostics::Deprecated(::STRINGS[7/*"Use the Tim...*/], this, ::STRINGS[8/*"/Users/star...*/], 547, ::STRINGS[9/*".ctor"*/]);
}
...
static void RaiseUserEvent_build(uType* type)
{
    ...
    ::STRINGS[11] = uString::Const("/Users/star-destryer/Library/Application Support/Fusetools/Packages/Fuse.UserEvents/1.1.1/$.uno");
...
void RaiseUserEvent__Perform_fn(RaiseUserEvent* __this, ::g::Fuse::Node* target)
{
    ...
    if (__this->_event == NULL)
        ::g::Fuse::Diagnostics::UserError(::g::Uno::String::op_Addition2(::STRINGS[10/*"no UserEven...*/], ::g::Uno::UX::Selector__op_Implicit1(__this->EventName())), __this, ::STRINGS[11/*"/Users/star...*/], 240, ::STRINGS[12/*"Perform"*/], NULL);
    else
...
static void ReleasePage_build(uType* type)
{
    ...
    ::STRINGS[14] = uString::Const("/Users/star-destryer/Library/Application Support/Fusetools/Packages/Fuse.Controls.Navigation/1.1.1/$.uno");
    ::STRINGS[12] = uString::Const("Perform");
    ::TYPES[1] = ::g::Fuse::Visual_typeof();
...
void ReleasePage__Perform_fn(ReleasePage* __this, ::g::Fuse::Node* n)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[13/*"Requires a ...*/], __this, ::STRINGS[14/*"/Users/star...*/], 283, ::STRINGS[12/*"Perform"*/], NULL);
        return;
    }
...
{
    ctor_3();
    ::g::Fuse::Diagnostics::Deprecated(::STRINGS[15/*"Use `Play` ...*/], this, ::STRINGS[8/*"/Users/star...*/], 490, ::STRINGS[9/*".ctor"*/]);
}
...
void TimelineAction__Perform_fn(TimelineAction* __this, ::g::Fuse::Node* target)
{
    ...
    if (t == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[17/*"`TimelineAc...*/], __this, ::STRINGS[8/*"/Users/star...*/], 827, ::STRINGS[12/*"Perform"*/], NULL);
        return;
    }
...
{
    ::g::Fuse::Diagnostics::Deprecated(::STRINGS[18/*"Use `Trigge...*/], this, ::STRINGS[8/*"/Users/star...*/], 963, ::STRINGS[19/*"set_Direction"*/]);
    When(value);
}
