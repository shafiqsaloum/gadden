...
#include <_root.gadden_FuseDrawingImageFill_Url_Property.h>
...
// public partial sealed class MainView.Template9 :586
// {
// static Template9() :601
static void MainView__Template9__cctor__fn(uType* __type)
{
    ...
    MainView__Template9::__selector0_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[0/*"Url"*/]);
    MainView__Template9::__selector1_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[1/*"Value"*/]);
}
...
static void MainView__Template9_build(uType* type)
{
    ...
    type->SetFields(2,
        ...
        ::g::Uno::UX::Property1_typeof()->MakeType(::g::Uno::String_typeof(), NULL), offsetof(::g::MainView__Template9, temp_Url_inst), 0,
...
void MainView__Template9__New1_fn(MainView__Template9* __this, uObject** __retval)
{
    ...
    __this->temp_Url_inst = ::g::gadden_FuseDrawingImageFill_Url_Property::New1(temp, MainView__Template9::__selector0());
    ...
    __this->temp1_Value_inst = ::g::gadden_FuseControlsTextInputControl_Value_Property::New1(temp1, MainView__Template9::__selector1());
    ...
    __this->temp2_Value_inst = ::g::gadden_FuseControlsTextInputControl_Value_Property::New1(temp2, MainView__Template9::__selector1());
...
// public Template9 New(MainView parent, MainView parentInstance) :590
...
// public Template9(MainView parent, MainView parentInstance) [instance] :590
...
// public Template9 New(MainView parent, MainView parentInstance) [static] :590
