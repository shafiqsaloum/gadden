...
{
    MainView__Template1::__g_static_nametable1_ = uArray::Init<uString*>(::TYPES[0/*string[]*/], 4, ::STRINGS[0/*"temp_eb9"*/], ::STRINGS[1/*"starImage"*/], ::STRINGS[2/*"yellowStar"*/], ::STRINGS[3/*"showDetails"*/]);
    MainView__Template1::__selector0_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[4/*"Value"*/]);
    MainView__Template1::__selector1_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[5/*"Color"*/]);
    MainView__Template1::__selector2_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[6/*"Opacity"*/]);
    MainView__Template1::__selector3_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[1/*"starImage"*/]);
    MainView__Template1::__selector4_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[2/*"yellowStar"*/]);
    MainView__Template1::__selector5_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[3/*"showDetails"*/]);
}
...
static void MainView__Template1_build(uType* type)
{
    ...
    type->SetFields(2,
        ...
        ::g::Uno::UX::Property1_typeof()->MakeType(::g::Uno::Float_typeof(), NULL), offsetof(::g::MainView__Template1, ExhibitorDetails_Opacity_inst), 0,
        ::g::Uno::UX::Property1_typeof()->MakeType(::g::Uno::Float_typeof(), NULL), offsetof(::g::MainView__Template1, ExibitorList_Opacity_inst), 0,
        ::g::Uno::UX::Property1_typeof()->MakeType(::g::Uno::Float4_typeof(), NULL), offsetof(::g::MainView__Template1, starImage_Color_inst), 0,
        ::g::Uno::UX::Property1_typeof()->MakeType(::g::Uno::String_typeof(), NULL), offsetof(::g::MainView__Template1, temp_Value_inst), 0,
...
void MainView__Template1__New1_fn(MainView__Template1* __this, uObject** __retval)
{
    ...
    __this->temp_Value_inst = ::g::gadden_FuseControlsTextControl_Value_Property::New1(temp, MainView__Template1::__selector0());
    ...
    __this->starImage_Color_inst = ::g::gadden_FuseControlsImage_Color_Property::New1(starImage1, MainView__Template1::__selector1());
    __this->ExhibitorDetails_Opacity_inst = ::g::gadden_FuseElementsElement_Opacity_Property::New1(uPtr(__this->__parent1)->ExhibitorDetails, MainView__Template1::__selector2());
    __this->ExibitorList_Opacity_inst = ::g::gadden_FuseElementsElement_Opacity_Property::New1(uPtr(__this->__parent1)->ExibitorList, MainView__Template1::__selector2());
    ...
    starImage1->Name(MainView__Template1::__selector3());
    ...
    yellowStar1->Name(MainView__Template1::__selector4());
    ...
    temp11->Duration(0.3);
    showDetails1->Name(MainView__Template1::__selector5());
