...
{
    MainView__Template1::__g_static_nametable1_ = uArray::Init<uString*>(::TYPES[0/*string[]*/], 1, ::STRINGS[0/*"imgtransform"*/]);
    MainView__Template1::__selector0_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[1/*"Url"*/]);
    MainView__Template1::__selector1_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[0/*"imgtransform"*/]);
}
...
static void MainView__Template1_build(uType* type)
{
    ...
    type->SetFields(2,
        ...
        ::g::Uno::UX::Property1_typeof()->MakeType(::g::Uno::String_typeof(), NULL), offsetof(::g::MainView__Template1, __self_Url_inst1), 0,
...
void MainView__Template1__New1_fn(MainView__Template1* __this, uObject** __retval)
{
    ...
    __this->__self_Url_inst1 = ::g::gadden_FuseControlsImage_Url_Property::New1(__self1, MainView__Template1::__selector0());
    ...
    imgtransform1->Name(MainView__Template1::__selector1());
