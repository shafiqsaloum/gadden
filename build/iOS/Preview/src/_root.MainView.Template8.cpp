...
// public partial sealed class MainView.Template8 :527
// {
// static Template8() :541
static void MainView__Template8__cctor__fn(uType* __type)
{
    ...
    MainView__Template8::__selector0_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[0/*"Value"*/]);
}
...
static void MainView__Template8_build(uType* type)
{
    ...
    type->SetFields(2,
        ...
        ::g::Uno::UX::Property1_typeof()->MakeType(::g::Uno::String_typeof(), NULL), offsetof(::g::MainView__Template8, temp_Value_inst), 0,
...
void MainView__Template8__New1_fn(MainView__Template8* __this, uObject** __retval)
{
    ...
    __this->temp_Value_inst = ::g::gadden_FuseControlsTextControl_Value_Property::New1(temp, MainView__Template8::__selector0());
    ...
    __this->temp1_Value_inst = ::g::gadden_FuseControlsTextInputControl_Value_Property::New1(temp1, MainView__Template8::__selector0());
...
// public Template8 New(MainView parent, MainView parentInstance) :531
...
// public Template8(MainView parent, MainView parentInstance) [instance] :531
...
// public Template8 New(MainView parent, MainView parentInstance) [static] :531
