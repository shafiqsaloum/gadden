...
// public partial sealed class MainView.Template8 :548
// {
// static Template8() :563
static void MainView__Template8__cctor__fn(uType* __type)
{
    MainView__Template8::__g_static_nametable1_ = uArray::Init<uString*>(::TYPES[0/*string[]*/], 0);
    MainView__Template8::__selector0_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[0/*"Url"*/]);
    MainView__Template8::__selector1_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[1/*"Value"*/]);
}
...
static void MainView__Template8_build(uType* type)
{
    ...
    type->SetFields(2,
        ::g::Uno::UX::NameTable_typeof(), offsetof(::g::MainView__Template8, __g_nametable1), 0,
        ...
        ::g::Uno::UX::Property1_typeof()->MakeType(::g::Uno::String_typeof(), NULL), offsetof(::g::MainView__Template8, temp_Url_inst), 0,
        ::g::Uno::UX::Property1_typeof()->MakeType(::g::Uno::String_typeof(), NULL), offsetof(::g::MainView__Template8, temp1_Value_inst), 0,
        ::g::Uno::UX::Property1_typeof()->MakeType(::g::Uno::String_typeof(), NULL), offsetof(::g::MainView__Template8, temp2_Value_inst), 0,
        ::TYPES[0/*string[]*/], (uintptr_t)&::g::MainView__Template8::__g_static_nametable1_, uFieldFlagsStatic,
        ::g::Uno::UX::Selector_typeof(), (uintptr_t)&::g::MainView__Template8::__selector0_, uFieldFlagsStatic,
        ::g::Uno::UX::Selector_typeof(), (uintptr_t)&::g::MainView__Template8::__selector1_, uFieldFlagsStatic);
...
void MainView__Template8__New1_fn(MainView__Template8* __this, uObject** __retval)
{
    ...
    __this->temp_Url_inst = ::g::gadden_FuseDrawingImageFill_Url_Property::New1(temp, MainView__Template8::__selector0());
    ::g::Fuse::Reactive::Data* temp3 = ::g::Fuse::Reactive::Data::New1(::STRINGS[2/*"image"*/]);
    __this->__g_nametable1 = ::g::Uno::UX::NameTable::New1(uPtr(__this->__parent1)->__g_nametable1, MainView__Template8::__g_static_nametable1());
    ::g::Fuse::Reactive::Data* temp4 = ::g::Fuse::Reactive::Data::New1(::STRINGS[3/*"name"*/]);
    ::g::Paragraph* temp1 = ::g::Paragraph::New4();
    __this->temp1_Value_inst = ::g::gadden_FuseControlsTextInputControl_Value_Property::New1(temp1, MainView__Template8::__selector1());
    ...
    __this->temp2_Value_inst = ::g::gadden_FuseControlsTextInputControl_Value_Property::New1(temp2, MainView__Template8::__selector1());
...
// public Template8 New(MainView parent, MainView parentInstance) :552
...
uSStrong<uArray*> MainView__Template8::__g_static_nametable1_;
::g::Uno::UX::Selector MainView__Template8::__selector0_;
::g::Uno::UX::Selector MainView__Template8::__selector1_;

// public Template8(MainView parent, MainView parentInstance) [instance] :552
...
// public Template8 New(MainView parent, MainView parentInstance) [static] :552
