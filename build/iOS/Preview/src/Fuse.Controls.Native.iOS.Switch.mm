...
// public sealed extern class Switch :2113
// {
...
// public Switch(Fuse.Controls.Native.IToggleViewHost host) :2125
void Switch__ctor_5_fn(Switch* __this, uObject* host)
{
    __this->ctor_5(host);
}

// private static ObjC.Object Create() :2145
void Switch__Create_fn(::g::ObjC::Object** __retval)
{
    *__retval = Switch::Create();
}

// public override sealed void Dispose() :2131
...
// private static bool GetValue(ObjC.Object handle) :2151
void Switch__GetValue_fn(::g::ObjC::Object* handle, bool* __retval)
{
    *__retval = Switch::GetValue(handle);
}

// public Switch New(Fuse.Controls.Native.IToggleViewHost host) :2125
void Switch__New3_fn(uObject* host, Switch** __retval)
{
    *__retval = Switch::New3(host);
}

// private void OnValueChanged(ObjC.Object sender, ObjC.Object uiEvent) :2139
...
// private static void SetValue(ObjC.Object handle, bool value) :2158
void Switch__SetValue_fn(::g::ObjC::Object* handle, bool* value)
{
    Switch::SetValue(handle, *value);
}

// public void set_Value(bool value) :2118
void Switch__set_Value_fn(Switch* __this, bool* value)
{
    __this->Value(*value);
}

// public Switch(Fuse.Controls.Native.IToggleViewHost host) [instance] :2125
...
// private void OnValueChanged(ObjC.Object sender, ObjC.Object uiEvent) [instance] :2139
...
// public void set_Value(bool value) [instance] :2118
void Switch::Value(bool value)
{
    Switch::SetValue(Handle(), value);
}

// private static ObjC.Object Create() [static] :2145
...
// private static bool GetValue(ObjC.Object handle) [static] :2151
...
// public Switch New(Fuse.Controls.Native.IToggleViewHost host) [static] :2125
...
// private static void SetValue(ObjC.Object handle, bool value) [static] :2158
