...
// {
// static Template7() :462
static void MainView__Template7__cctor__fn(uType* __type)
{
    MainView__Template7::__g_static_nametable1_ = uArray::Init<uString*>(::TYPES[0/*string[]*/], 1, ::STRINGS[0/*"temp_eb14"*/]);
    MainView__Template7::__selector0_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[1/*"Url"*/]);
    MainView__Template7::__selector1_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[2/*"Value"*/]);
    MainView__Template7::__selector2_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[3/*"Visibility"*/]);
}

static void MainView__Template7_build(uType* type)
{
    ::STRINGS[0] = uString::Const("temp_eb14");
    ...
    type->SetFields(2,
        ...
        ::g::Uno::UX::Property1_typeof()->MakeType(::g::Fuse::Elements::Visibility_typeof(), NULL), offsetof(::g::MainView__Template7, ProgramDetails_Visibility_inst), 0,
        ::g::Uno::UX::Property1_typeof()->MakeType(::g::Fuse::Elements::Visibility_typeof(), NULL), offsetof(::g::MainView__Template7, ProgramFeed_Visibility_inst), 0,
        ::g::Uno::UX::Property1_typeof()->MakeType(::g::Uno::String_typeof(), NULL), offsetof(::g::MainView__Template7, temp_Url_inst), 0,
        ::g::Uno::UX::Property1_typeof()->MakeType(::g::Uno::String_typeof(), NULL), offsetof(::g::MainView__Template7, temp1_Value_inst), 0,
        ::g::Uno::UX::Property1_typeof()->MakeType(::g::Uno::String_typeof(), NULL), offsetof(::g::MainView__Template7, temp2_Value_inst), 0,
        ...
        ::g::Uno::UX::Selector_typeof(), (uintptr_t)&::g::MainView__Template7::__selector1_, uFieldFlagsStatic,
        ::g::Uno::UX::Selector_typeof(), (uintptr_t)&::g::MainView__Template7::__selector2_, uFieldFlagsStatic);
...
// public Template7(MainView parent, MainView parentInstance) :447
...
void MainView__Template7__New1_fn(MainView__Template7* __this, uObject** __retval)
{
    ...
    __this->temp_Url_inst = ::g::gadden_FuseControlsImage_Url_Property::New1(temp, MainView__Template7::__selector0());
    ...
    __this->temp1_Value_inst = ::g::gadden_FuseControlsTextInputControl_Value_Property::New1(temp1, MainView__Template7::__selector1());
    ::g::Fuse::Reactive::Data* temp4 = ::g::Fuse::Reactive::Data::New1(::STRINGS[5/*"name"*/]);
    ::g::SmallText* temp2 = ::g::SmallText::New4();
    __this->temp2_Value_inst = ::g::gadden_FuseControlsTextControl_Value_Property::New1(temp2, MainView__Template7::__selector1());
    ::g::Fuse::Reactive::Data* temp5 = ::g::Fuse::Reactive::Data::New1(::STRINGS[6/*"location"*/]);
    __this->ProgramDetails_Visibility_inst = ::g::gadden_FuseElementsElement_Visibility_Property::New1(uPtr(__this->__parent1)->ProgramDetails, MainView__Template7::__selector2());
    __this->ProgramFeed_Visibility_inst = ::g::gadden_FuseElementsElement_Visibility_Property::New1(uPtr(__this->__parent1)->ProgramFeed, MainView__Template7::__selector2());
    ...
    ::g::Fuse::Reactive::EventBinding* temp_eb141 = ::g::Fuse::Reactive::EventBinding::New1((uObject*)temp6, __this->__g_nametable1);
    ...
    temp12->Alignment(3);
    temp12->File(::g::Uno::UX::BundleFileSource::New1(::g::gadden_bundle::ArrowRightWhite3d207980()));
    ...
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp13->Bindings()), ::TYPES[3/*Uno.Collections.ICollection<Fuse.Binding>*/]), temp_eb141);
    ::g::Fuse::Triggers::Actions::Set__set_Value_fn(temp14, uCRef<int>(0));
    temp14->Delay(0.2f);
    ::g::Fuse::Triggers::Actions::Set__set_Value_fn(temp15, uCRef<int>(2));
    temp15->Delay(0.2f);
    temp16->add_Handler(uDelegate::New(::TYPES[5/*Fuse.VisualEventHandler*/], (void*)::g::Fuse::Reactive::EventBinding__OnEvent_fn, temp_eb141));
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(uPtr(__this->__g_nametable1)->Objects()), ::TYPES[6/*Uno.Collections.ICollection<object>*/]), temp_eb141);
...
// public Template7 New(MainView parent, MainView parentInstance) :447
...
// public Template7(MainView parent, MainView parentInstance) [instance] :447
...
// public Template7 New(MainView parent, MainView parentInstance) [static] :447
