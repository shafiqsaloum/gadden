...
// /Users/star-destryer/Library/Application Support/Fusetools/Packages/Fuse.Scripting/1.1.1/$.uno
// ----------------------------------------------------------------------------------------------
...
static void NativeEvent_build(uType* type)
{
    ...
    ::STRINGS[30] = uString::Const("../../../Library/Application Support/Fusetools/Packages/Fuse.Scripting/1.1.1/$.uno");
...
static void ScriptModule__RequireContext_build(uType* type)
{
    ...
    ::STRINGS[40] = uString::Const("/Users/star-destryer/Library/Application Support/Fusetools/Packages/Fuse.Scripting/1.1.1/$.uno");
...
uObject* ScriptModule__RequireContext::Require1(uString* id)
{
    ...
    if (module == NULL)
    {
        ...
        if (module->Error() == NULL)
        {
            ...
            {
                ::g::Fuse::Diagnostics::UserSuccess(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[38/*"JavaScript ...*/], path), ::STRINGS[39/*" was fixed!"*/]), this, ::STRINGS[40/*"/Users/star...*/], 1879, ::STRINGS[41/*"Require"*/]);
        ...
        else
        {
            ...
            {
                ::g::Fuse::Diagnostics::UserError(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[38/*"JavaScript ...*/], path), ::STRINGS[42/*" line "*/]), uBox<int>(::TYPES[47/*int*/], uPtr(e)->LineNumber())), ::STRINGS[43/*". "*/]), uPtr(e)->ErrorMessage()), this, ::STRINGS[40/*"/Users/star...*/], 1889, ::STRINGS[41/*"Require"*/], NULL);
...
void ScriptMethod1__Call_fn(ScriptMethod1* __this, ::g::Fuse::Scripting::Context* c, uObject* obj, uArray* args, uObject** __retval)
{
    ...
    if (__this->Thread == 2)
    {
        ...
        {
            ::g::Fuse::Diagnostics::InternalError(::STRINGS[50/*"Cannot call...*/], __this, ::STRINGS[40/*"/Users/star...*/], 1582, ::STRINGS[51/*"Call"*/]);
            return *__retval = NULL, void();
        }
