...
static void MainView__Template4__cctor__fn(uType* __type)
{
    ...
    MainView__Template4::__selector1_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[1/*"Background"*/]);
}
...
static void MainView__Template4_build(uType* type)
{
    ...
    type->SetFields(2,
        ...
        ::g::Uno::UX::Property1_typeof()->MakeType(::g::Fuse::Drawing::Brush_typeof(), NULL), offsetof(::g::MainView__Template4, __self_Background_inst1), 0,
...
// public override sealed object New() :306
void MainView__Template4__New1_fn(MainView__Template4* __this, uObject** __retval)
{
    ...
    __this->__self_Background_inst1 = ::g::gadden_FuseControlsControl_Background_Property::New1(__self1, MainView__Template4::__selector1());
