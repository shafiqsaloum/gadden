...
{
    uStackFrame __("gadden_accessor_Tab_Text", "GetAsObject(Uno.UX.PropertyObject)");
...
{
    uStackFrame __("gadden_accessor_Tab_Text", "SetAsObject(Uno.UX.PropertyObject,object,Uno.UX.IPropertyListener)");
