// This file was generated based on '/Users/ericaglimsholt/Documents/Skola/Handels marketing/Gadden/gadden/build/iOS/Preview/cache/ux11/TitleBig.g.uno'.
...
// {
// static TitleBig() :4
static void TitleBig__cctor_4_fn(uType* __type)
{
}

static void TitleBig_build(uType* type)
{
    type->SetInterfaces(
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)TitleBig__New4_fn, 0, true, type, 0));
}
...
::g::Fuse::Controls::TextControl_type* TitleBig_typeof()
{
    ...
    options.ObjectSize = sizeof(TitleBig);
    options.TypeSize = sizeof(::g::Fuse::Controls::TextControl_type);
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("TitleBig", options);
    type->fp_build_ = TitleBig_build;
    type->fp_ctor_ = (void*)TitleBig__New4_fn;
    type->fp_cctor_ = TitleBig__cctor_4_fn;
...
// public TitleBig New() :8
void TitleBig__New4_fn(TitleBig** __retval)
{
    *__retval = TitleBig::New4();
}

// public TitleBig() [instance] :8
void TitleBig::ctor_8()
{
    ctor_7();
    InitializeUX1();
}
...
// public TitleBig New() [static] :8
TitleBig* TitleBig::New4()
{
    TitleBig* obj1 = (TitleBig*)uNew(TitleBig_typeof());
    obj1->ctor_8();
    return obj1;
}
// }
