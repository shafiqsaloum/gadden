// This file was generated based on '.uno/ux11/Profile.g.uno'.
...
::g::Fuse::Controls::Control_type* Profile_typeof()
{
    ...
    type = (::g::Fuse::Controls::Control_type*)uClassType::New("Profile", options);
