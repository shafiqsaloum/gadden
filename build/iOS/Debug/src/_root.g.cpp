...
// /Users/ericaglimsholt/Library/Application Support/Fusetools/Packages/Fuse.Controls/0.47.7/.uno/package
// ------------------------------------------------------------------------------------------------------
...
// /Users/ericaglimsholt/Library/Application Support/Fusetools/Packages/Fuse.Controls.Native/0.47.7/.uno/package
// -------------------------------------------------------------------------------------------------------------
...
// /Users/ericaglimsholt/Library/Application Support/Fusetools/Packages/Fuse.Controls.Panels/0.47.7/.uno/package
// -------------------------------------------------------------------------------------------------------------
...
// /Users/ericaglimsholt/Library/Application Support/Fusetools/Packages/Fuse.Controls.Primitives/0.47.7/.uno/package
// -----------------------------------------------------------------------------------------------------------------
...
// /Users/ericaglimsholt/Library/Application Support/Fusetools/Packages/Fuse.Controls.Video/0.47.7/.uno/package
// ------------------------------------------------------------------------------------------------------------
...
{
    FuseControlsVideo_bundle::Scale9Rectangleda875692_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[38/*"uniform flo...*/], ::STRINGS[39/*"uniform sam...*/], 0, 2, uArray::Init<uString*>(::TYPES[0/*string[]*/], 16, ::STRINGS[4/*"a"*/], ::STRINGS[2/*"b"*/], ::STRINGS[3/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[6/*"e"*/], ::STRINGS[7/*"f"*/], ::STRINGS[8/*"g"*/], ::STRINGS[9/*"h"*/], ::STRINGS[10/*"i"*/], ::STRINGS[11/*"j"*/], ::STRINGS[12/*"k"*/], ::STRINGS[13/*"l"*/], ::STRINGS[14/*"m"*/], ::STRINGS[15/*"n"*/], ::STRINGS[16/*"o"*/], ::STRINGS[18/*"q"*/]));
    FuseControlsVideo_bundle::VideoDrawElement5c829975_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[40/*"uniform mat...*/], ::STRINGS[41/*"uniform sam...*/], 1, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 7, ::STRINGS[2/*"b"*/], ::STRINGS[4/*"a"*/], ::STRINGS[3/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[6/*"e"*/], ::STRINGS[7/*"f"*/], ::STRINGS[9/*"h"*/]));
}
...
static void FuseControlsVideo_bundle_build(uType* type)
{
    ::STRINGS[38] = uString::Const("uniform float c, d, e, f, g, h, k, l, m, n;\n"
        ...
        "}\n"
        "");
    ::STRINGS[39] = uString::Const("uniform sampler2D q;\n"
        "\n"
        "varying vec2 p;\n"
        "\n"
        "void main()\n"
    ...
    ::STRINGS[40] = uString::Const("uniform mat4 f, c;\n"
        ...
        "}\n"
        "");
    ::STRINGS[41] = uString::Const("uniform sampler2D h;\n"
        "\n"
        "varying vec2 g;\n"
        "\n"
        "void main()\n"
...
// /Users/ericaglimsholt/Library/Application Support/Fusetools/Packages/Fuse.Drawing/0.47.7/.uno/package
// -----------------------------------------------------------------------------------------------------
...
{
    FuseDrawing_bundle::LinearGradientDrawable479fd075_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[42/*"attribute v...*/], ::STRINGS[43/*"uniform flo...*/], 3, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 7, ::STRINGS[2/*"b"*/], ::STRINGS[3/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[4/*"a"*/], ::STRINGS[6/*"e"*/], ::STRINGS[7/*"f"*/], ::STRINGS[8/*"g"*/]));
}
...
// /Users/ericaglimsholt/Library/Application Support/Fusetools/Packages/Fuse.Drawing.Primitives/0.47.7/.uno/package
// ----------------------------------------------------------------------------------------------------------------
...
static void FuseDrawingPrimitives_bundle__cctor__fn(uType* __type)
{
    ...
    FuseDrawingPrimitives_bundle::Circlef28f173b_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[89/*"uniform vec...*/], ::STRINGS[90/*"uniform flo...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 8, ::STRINGS[4/*"a"*/], ::STRINGS[2/*"b"*/], ::STRINGS[3/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[6/*"e"*/], ::STRINGS[7/*"f"*/], ::STRINGS[8/*"g"*/], ::STRINGS[9/*"h"*/]));
...
{
    ::STRINGS[44] = uString::Const("uniform vec2 b, c, e, f, g, n;\n"
        "uniform mat4 d;\n"
        "uniform float o;\n"
        "\n"
        "attribute vec2 a;\n"
        ...
        "}\n"
        "");
    ::STRINGS[45] = uString::Const("uniform float h, i, j, k, l, m;\n"
        "uniform vec2 p, q, r;\n"
        "\n"
        "uniform sampler2D u;\n"
        "\n"
    ...
    ::STRINGS[48] = uString::Const("uniform vec2 d, e, g, h, i, j, k, m, l;\n"
        "uniform mat4 f;\n"
        "\n"
        "attribute vec2 a;\n"
        "\n"
        ...
        "}\n"
        "");
    ::STRINGS[49] = uString::Const("uniform vec2 o, n, w, x, y;\n"
        "uniform vec4 p;\n"
    ...
    ::STRINGS[56] = uString::Const("uniform vec2 b, c, e, f, g, l;\n"
        "uniform mat4 d;\n"
        "uniform float m;\n"
        "\n"
        "attribute vec2 a;\n"
    ...
    ::STRINGS[67] = uString::Const("uniform float e, f, g, h, i, k;\n"
        ...
        "}\n"
        "");
    ::STRINGS[68] = uString::Const("uniform vec2 o, n, w, x, y;\n"
        "uniform vec4 p;\n"
        "uniform float q, r, s, t, u, v;\n"
        "\n"
        "uniform sampler2D C;\n"
    ...
    ::STRINGS[69] = uString::Const("uniform vec2 b, c;\n"
        ...
        "}\n"
        "");
    ::STRINGS[70] = uString::Const("uniform float e, f, g, h, i;\n"
        "uniform vec2 k, l, m;\n"
        "uniform vec4 j;\n"
        "\n"
        "varying vec2 n;\n"
    ...
    ::STRINGS[80] = uString::Const("uniform vec2 o, n;\n"
        ...
        "}\n"
        "");
    ::STRINGS[81] = uString::Const("uniform vec2 o, n, u, v, w;\n"
        "uniform vec4 p;\n"
        "uniform float q, r, s, t;\n"
        "\n"
        "uniform sampler2D A;\n"
    ...
    ::STRINGS[86] = uString::Const("uniform float e, f, g, i;\n"
        ...
        "}\n"
        "");
    ::STRINGS[87] = uString::Const("uniform float e, f, g, i;\n"
        "uniform vec2 j, k, l;\n"
        "uniform vec4 h;\n"
        "\n"
        "varying vec2 m;\n"
        ...
        "}\n"
        "");
    ::STRINGS[88] = uString::Const("uniform float e, f, g, h, i, k;\n"
        "uniform vec2 l, m, n;\n"
        "uniform vec4 j;\n"
        "\n"
        "varying vec2 o;\n"
    ...
    ::STRINGS[91] = uString::Const("uniform float e, f, g;\n"
        ...
        "}\n"
        "");
    ::STRINGS[92] = uString::Const("uniform float e, f, g;\n"
        "uniform vec2 i, j, k;\n"
        "uniform vec4 h;\n"
        "\n"
        "varying vec2 l;\n"
        ...
        "}\n"
        "");
    ::STRINGS[93] = uString::Const("uniform float e[d], o;\n"
        ...
        "}\n"
        "");
    ::STRINGS[94] = uString::Const("uniform float k, l, m;\n"
        "\n"
        "uniform sampler2D t;\n"
        "\n"
        "varying float p, q;\n"
        ...
        "}\n"
        "");
    ::STRINGS[95] = uString::Const("uniform float k, l, m;\n"
        "\n"
        "uniform sampler2D t;\n"
        "\n"
        "varying float p, q;\n"
    ...
    ::STRINGS[97] = uString::Const("uniform float h, i;\n"
        ...
        "}\n"
        "");
    ::STRINGS[98] = uString::Const("uniform float h, i;\n"
        "uniform vec4 j;\n"
        "\n"
        "varying float k;\n"
        "varying vec2 l, m;\n"
        ...
        "}\n"
        "");
    ::STRINGS[99] = uString::Const("uniform float g[d];\n"
    ...
    ::STRINGS[103] = uString::Const("uniform float e[d];\n"
        ...
        "}\n"
        "");
    ::STRINGS[104] = uString::Const("uniform float h, i, j, k;\n"
        "uniform vec4 l;\n"
        "\n"
        "varying float m;\n"
        "varying vec2 n, o;\n"
    ...
    ::STRINGS[106] = uString::Const("uniform float h, i, k;\n"
        ...
        "}\n"
        "");
    ::STRINGS[107] = uString::Const("uniform float h, i, k;\n"
        "uniform vec4 j;\n"
        "\n"
        "varying float l;\n"
        "varying vec2 m, n;\n"
    ...
    ::STRINGS[114] = uString::Const("uniform float h, i, j, k, m;\n"
        ...
        "}\n"
        "");
    ::STRINGS[115] = uString::Const("uniform float h, i, j, k, m;\n"
        "uniform vec4 l;\n"
        "\n"
        "varying float n;\n"
        "varying vec2 o, p;\n"
        ...
        "}\n"
        "");
    ::STRINGS[116] = uString::Const("uniform float e[d], q;\n"
        ...
        "}\n"
        "");
    ::STRINGS[117] = uString::Const("uniform float k, l, m, n, o;\n"
        "\n"
        "uniform sampler2D v;\n"
        "\n"
        "varying float r, s;\n"
        ...
        "}\n"
        "");
    ::STRINGS[118] = uString::Const("uniform float k, l, m, n, o;\n"
        "\n"
        "uniform sampler2D v;\n"
        "\n"
        "varying float r, s;\n"
...
// /Users/ericaglimsholt/Library/Application Support/Fusetools/Packages/Fuse.Effects/0.47.7/.uno/package
// -----------------------------------------------------------------------------------------------------
...
{
    FuseEffects_bundle::Blitter6e650d31_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[119/*"uniform mat...*/], ::STRINGS[120/*"uniform vec...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 7, ::STRINGS[4/*"a"*/], ::STRINGS[2/*"b"*/], ::STRINGS[3/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[6/*"e"*/], ::STRINGS[7/*"f"*/], ::STRINGS[9/*"h"*/]));
    ...
    FuseEffects_bundle::Desaturate88bb7f94_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[30/*"uniform mat...*/], ::STRINGS[121/*"uniform flo...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 5, ::STRINGS[4/*"a"*/], ::STRINGS[2/*"b"*/], ::STRINGS[3/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[7/*"f"*/]));
    FuseEffects_bundle::Duotone26eb7e3c_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[119/*"uniform mat...*/], ::STRINGS[122/*"uniform vec...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 7, ::STRINGS[4/*"a"*/], ::STRINGS[2/*"b"*/], ::STRINGS[3/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[6/*"e"*/], ::STRINGS[7/*"f"*/], ::STRINGS[9/*"h"*/]));
    FuseEffects_bundle::EffectHelpers52052d40_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[123/*"attribute v...*/], ::STRINGS[124/*"uniform flo...*/], 3, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 7, ::STRINGS[2/*"b"*/], ::STRINGS[3/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[4/*"a"*/], ::STRINGS[6/*"e"*/], ::STRINGS[7/*"f"*/], ::STRINGS[9/*"h"*/]));
    FuseEffects_bundle::EffectHelpers9b892494_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[125/*"attribute v...*/], ::STRINGS[126/*"uniform sam...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 2, ::STRINGS[4/*"a"*/], ::STRINGS[3/*"c"*/]));
...
static void FuseEffects_bundle_build(uType* type)
{
    ...
    ::STRINGS[30] = uString::Const("uniform mat4 d, b;\n"
        ...
        "}\n"
        "");
    ::STRINGS[121] = uString::Const("uniform float c;\n"
        "\n"
        "uniform sampler2D f;\n"
        "\n"
        "varying vec2 e;\n"
        ...
        "}\n"
        "");
    ::STRINGS[122] = uString::Const("uniform vec3 c, d;\n"
        "uniform float e;\n"
        "\n"
        "uniform sampler2D h;\n"
        "\n"
        ...
        "}\n"
        "");
    ::STRINGS[123] = uString::Const("attribute vec2 a;\n"
        "\n"
        "varying vec2 g;\n"
        "\n"
        "void main()\n"
        ...
        "}\n"
        "");
    ::STRINGS[124] = uString::Const("uniform float e[b];\n"
        "uniform vec2 f[d];\n"
        "\n"
        "uniform sampler2D h;\n"
        "\n"
...
// /Users/ericaglimsholt/Library/Application Support/Fusetools/Packages/Fuse.Elements/0.47.7/.uno/package
// ------------------------------------------------------------------------------------------------------
...
// /Users/ericaglimsholt/Library/Application Support/Fusetools/Packages/Fuse.Nodes/0.47.7/.uno/package
// ---------------------------------------------------------------------------------------------------
...
// /Users/ericaglimsholt/Library/Application Support/Fusetools/Packages/Fuse.Reactive.JavaScript/0.47.7/.uno/package
// -----------------------------------------------------------------------------------------------------------------
...
{
    FuseReactiveJavaScript_bundle::Diagnostics16aaa8c0_ = uPtr(::g::Uno::IO::Bundle::Get(::STRINGS[147/*"Fuse.Reacti...*/]))->GetFile(::STRINGS[148/*"diagnostics...*/]);
    FuseReactiveJavaScript_bundle::es6promisemin65cc4303_ = uPtr(::g::Uno::IO::Bundle::Get(::STRINGS[147/*"Fuse.Reacti...*/]))->GetFile(::STRINGS[149/*"es6-promise...*/]);
    FuseReactiveJavaScript_bundle::Observable49677b23_ = uPtr(::g::Uno::IO::Bundle::Get(::STRINGS[147/*"Fuse.Reacti...*/]))->GetFile(::STRINGS[150/*"observable-...*/]);
    FuseReactiveJavaScript_bundle::setTimeouta19c575b_ = uPtr(::g::Uno::IO::Bundle::Get(::STRINGS[147/*"Fuse.Reacti...*/]))->GetFile(::STRINGS[151/*"settimeout-...*/]);
}
...
static void FuseReactiveJavaScript_bundle_build(uType* type)
{
    ...
    type->SetFields(0,
        ::g::Uno::IO::BundleFile_typeof(), (uintptr_t)&::g::FuseReactiveJavaScript_bundle::Diagnostics16aaa8c0_, uFieldFlagsStatic,
        ::g::Uno::IO::BundleFile_typeof(), (uintptr_t)&::g::FuseReactiveJavaScript_bundle::es6promisemin65cc4303_, uFieldFlagsStatic,
        ::g::Uno::IO::BundleFile_typeof(), (uintptr_t)&::g::FuseReactiveJavaScript_bundle::Observable49677b23_, uFieldFlagsStatic,
        ::g::Uno::IO::BundleFile_typeof(), (uintptr_t)&::g::FuseReactiveJavaScript_bundle::setTimeouta19c575b_, uFieldFlagsStatic);
}
...
uSStrong< ::g::Uno::IO::BundleFile*> FuseReactiveJavaScript_bundle::Diagnostics16aaa8c0_;
uSStrong< ::g::Uno::IO::BundleFile*> FuseReactiveJavaScript_bundle::es6promisemin65cc4303_;
uSStrong< ::g::Uno::IO::BundleFile*> FuseReactiveJavaScript_bundle::Observable49677b23_;
uSStrong< ::g::Uno::IO::BundleFile*> FuseReactiveJavaScript_bundle::setTimeouta19c575b_;
// }
