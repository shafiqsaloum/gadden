...
static void Element_build(uType* type)
{
    ...
    ::STRINGS[7] = uString::Const("../../../../../Library/Application Support/Fusetools/Packages/Fuse.Elements/0.47.7/$.uno");
    ...
    ::STRINGS[9] = uString::Const("/Users/ericaglimsholt/Library/Application Support/Fusetools/Packages/Fuse.Elements/0.47.7/$.uno");
...
void Element__Draw_fn(Element* __this, ::g::Fuse::DrawContext* dc)
{
    if (!__this->IsRootingCompleted())
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[12/*"Draw called...*/], __this, ::STRINGS[9/*"/Users/eric...*/], 876, ::STRINGS[13/*"Draw"*/]);
...
::g::Uno::Graphics::Framebuffer* Element::CaptureRegion(::g::Fuse::DrawContext* dc, ::g::Uno::Rect region, ::g::Uno::Float2 padding)
{
    ...
    {
        ::g::Uno::Diagnostics::Debug::Log5(::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::STRINGS[5/*"CaptureRegi...*/], uBox(::g::Uno::Int2_typeof(), fsz)), ::STRINGS[6/*", max-size: "*/]), uBox<int>(::g::Uno::Int_typeof(), ::g::Uno::Graphics::Texture2D::MaxSize())), 1, ::STRINGS[7/*"../../../.....*/], 852);
        return NULL;
    }
...
void Element::Composit(::g::Fuse::DrawContext* dc)
{
    ...
    if (!flat && !_warnOpacityFlat)
    {
        ...
        ::g::Fuse::Diagnostics::UserWarning(::STRINGS[8/*"This elemen...*/], this, ::STRINGS[9/*"/Users/eric...*/], 1038, ::STRINGS[10/*"Composit"*/]);
    }
    ...
    if (!r && !_warnNoCacheDraw)
    {
        ...
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[11/*"This elemen...*/], this, ::STRINGS[9/*"/Users/eric...*/], 1046, ::STRINGS[10/*"Composit"*/]);
    }
}
...
static void ElementBatcher_build(uType* type)
{
    ...
    ::STRINGS[25] = uString::Const("../../../../../Library/Application Support/Fusetools/Packages/Fuse.Elements/0.47.7/caching/$.uno");
...
void ElementBatcher::UpdateDrawList()
{
    ...
    for (::g::Uno::Collections::List__Enumerator<uStrong< ::g::Fuse::Visual*> > enum4 = (::g::Uno::Collections::List__GetEnumerator_fn(uPtr(_elements), &ret25), ret25); enum4.MoveNext(::TYPES[44/*Uno.Collections.List<Fuse.Visual>.Enumerator*/]); )
    {
        ...
        if (emitNewBatch || (atlas == NULL))
        {
            ...
            {
                ::g::Uno::Diagnostics::Debug::Log5(::STRINGS[24/*"BUG: atlas-...*/], 1, ::STRINGS[25/*"../../../.....*/], 1061);
