...
// internal sealed class gadden_Tab_Text_Property :81
// {
...
// public gadden_Tab_Text_Property(Tab obj, Uno.UX.Selector name) :84
void gadden_Tab_Text_Property__ctor_3_fn(gadden_Tab_Text_Property* __this, ::g::Tab* obj, ::g::Uno::UX::Selector* name)
{
    __this->ctor_3(obj, *name);
}

// public override sealed string Get(Uno.UX.PropertyObject obj) :86
...
// public gadden_Tab_Text_Property New(Tab obj, Uno.UX.Selector name) :84
...
// public override sealed void Set(Uno.UX.PropertyObject obj, string v, Uno.UX.IPropertyListener origin) :87
...
// public gadden_Tab_Text_Property(Tab obj, Uno.UX.Selector name) [instance] :84
...
// public gadden_Tab_Text_Property New(Tab obj, Uno.UX.Selector name) [static] :84
