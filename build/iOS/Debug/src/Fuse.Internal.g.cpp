...
static void ImageContainer_build(uType* type)
{
    ...
    ::STRINGS[2] = uString::Const("/Users/ericaglimsholt/Library/Application Support/Fusetools/Packages/Fuse.Elements/0.47.7/internal/$.uno");
...
void ImageContainer::ResampleMode(int value)
{
    ...
    {
        if (value == 2)
            ::g::Fuse::Diagnostics::Deprecated(::STRINGS[1/*"ResampleMod...*/], this, ::STRINGS[2/*"/Users/eric...*/], 254, ::STRINGS[3/*"set_Resampl...*/]);
