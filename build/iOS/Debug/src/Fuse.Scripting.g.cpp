...
static void NativeEvent_build(uType* type)
{
    ...
    ::STRINGS[23] = uString::Const("../../../../../Library/Application Support/Fusetools/Packages/Fuse.Scripting/0.47.7/$.uno");
...
{
    ::g::Uno::Diagnostics::Debug::Assert(Context() != NULL, ::STRINGS[22/*"this.Contex...*/], ::STRINGS[23/*"../../../.....*/], 899, uArray::New(::TYPES[8/*object[]*/], 0));
...
static void ScriptModule__RequireContext_build(uType* type)
{
    ...
    ::STRINGS[33] = uString::Const("/Users/ericaglimsholt/Library/Application Support/Fusetools/Packages/Fuse.Scripting/0.47.7/$.uno");
...
uObject* ScriptModule__RequireContext::Require1(uString* id)
{
    ...
    if (module == NULL)
    {
        ...
        if (module->Error() == NULL)
        {
            ...
            {
                ::g::Fuse::Diagnostics::UserSuccess(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[31/*"JavaScript ...*/], path), ::STRINGS[32/*" was fixed!"*/]), this, ::STRINGS[33/*"/Users/eric...*/], 1854, ::STRINGS[34/*"Require"*/]);
        ...
        else
        {
            ...
            {
                ::g::Fuse::Diagnostics::UserError(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[31/*"JavaScript ...*/], path), ::STRINGS[35/*" line "*/]), uBox<int>(::TYPES[44/*int*/], uPtr(e)->LineNumber())), ::STRINGS[36/*". "*/]), uPtr(e)->ErrorMessage()), this, ::STRINGS[33/*"/Users/eric...*/], 1864, ::STRINGS[34/*"Require"*/], NULL);
...
void ScriptMethod1__Call_fn(ScriptMethod1* __this, ::g::Fuse::Scripting::Context* c, uObject* obj, uArray* args, uObject** __retval)
{
    ...
    if (__this->Thread == 2)
    {
        ...
        {
            ::g::Fuse::Diagnostics::InternalError(::STRINGS[43/*"Cannot call...*/], __this, ::STRINGS[33/*"/Users/eric...*/], 1582, ::STRINGS[44/*"Call"*/]);
            return *__retval = NULL, void();
        }
...
void ScriptModule__Evaluate_fn(ScriptModule* __this, ::g::Fuse::Scripting::Context* c, ::g::Fuse::Scripting::ModuleResult* result)
{
    ...
    uString* wrappedCode = ::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[50/*"(function("*/], __this->GenerateArgs(c, result, args)), ::STRINGS[51/*") { "*/]), uString::CharArray(newlines)), __this->Code()), ::STRINGS[52/*"\n })"*/]);
