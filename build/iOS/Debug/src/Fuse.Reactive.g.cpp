...
static void FunctionMirror__CallClosure_build(uType* type)
{
    ...
    ::STRINGS[5] = uString::Const("/Users/ericaglimsholt/Library/Application Support/Fusetools/Packages/Fuse.Reactive.JavaScript/0.47.7/$.uno");
...
void FunctionMirror__CallClosure::Call()
{
    ...
    catch (const uThrowable& __t)
    {
        if (uIs(__t.Exception, ::TYPES[11/*Fuse.Scripting.ScriptException*/]))
        {
            ...
            ::g::Fuse::Reactive::JavaScript::UserScriptError(::STRINGS[4/*"JavaScript ...*/], ex, this, ::STRINGS[5/*"/Users/eric...*/], 200, ::STRINGS[6/*"Call"*/]);
        }
        else throw __t;
    }
}
...
{
    ::STRINGS[12] = uString::Const("../../../../../Library/Application Support/Fusetools/Packages/Fuse.Reactive.JavaScript/0.47.7/fusejs/$.uno");
...
uObject* Console::Dir(uArray* args)
{
    ...
    ::g::Uno::Diagnostics::Debug::Log5(builder->ToString(), 1, ::STRINGS[12/*"../../../.....*/], 135);
    return NULL;
}
...
{
    for (int i = 0; i < uPtr(args)->Length(); i++)
        ::g::Uno::Diagnostics::Debug::Log5((uPtr(args)->Strong<uObject*>(i) != NULL) ? (uString*)::g::Uno::Object::ToString(uPtr(uPtr(args)->Strong<uObject*>(i))) : ::STRINGS[13/*"null"*/], 1, ::STRINGS[12/*"../../../.....*/], 121);
...
static void DataBinding_build(uType* type)
{
    ...
    ::STRINGS[32] = uString::Const("/Users/ericaglimsholt/Library/Application Support/Fusetools/Packages/Fuse.Reactive.Bindings/0.47.7/$.uno");
...
void DataBinding::TryPushAsMarshalledValue(uObject* newValue)
{
    ...
    if (::g::Fuse::Marshal::TryConvertTo(uPtr(Target())->PropertyType(), newValue, &res, this))
    {
        ...
        catch (const uThrowable& __t)
        {
            ...
            ::g::Fuse::Diagnostics::UserError(e->ToString(), Target(), ::STRINGS[32/*"/Users/eric...*/], 409, ::STRINGS[34/*"TryPushAsMa...*/], NULL);
        }
    }
}
...
{
    for (int i = 0; i < uPtr(args)->Length(); i++)
        ::g::Uno::Diagnostics::Debug::Log5((uPtr(args)->Strong<uObject*>(i) != NULL) ? (uString*)::g::Uno::Object::ToString(uPtr(uPtr(args)->Strong<uObject*>(i))) : ::STRINGS[13/*"null"*/], 1, ::STRINGS[12/*"../../../.....*/], 99);
...
static void Instantiator_build(uType* type)
{
    ...
    ::TYPES[41] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Node_typeof(), NULL), NULL);
    ::TYPES[42] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Fuse::Node_typeof(), uObject_typeof(), NULL);
    ::TYPES[43] = ::g::Fuse::Node_typeof();
    ::TYPES[31] = ::g::Fuse::Reactive::IObservable_typeof();
    ::TYPES[44] = Instantiator__ObservableLink_typeof();
    ::TYPES[45] = Instantiator__CountItem_typeof();
    ::TYPES[3] = uObject_typeof()->Array();
    ::TYPES[28] = ::g::Fuse::IArray_typeof();
    ::TYPES[46] = ::g::Fuse::IObject_typeof();
    ::TYPES[23] = ::g::Uno::String_typeof();
    ::TYPES[47] = ::g::Uno::Collections::List_typeof()->MakeType(::TYPES[43/*Fuse.Node*/], NULL);
    ...
    ::TYPES[50] = ::g::Uno::Collections::EnumerableExtensions_typeof()->MakeMethod(2/*IndexOf<Fuse.Node>*/, ::TYPES[43/*Fuse.Node*/], NULL);
    ::TYPES[29] = ::g::Uno::IDisposable_typeof();
    ::TYPES[51] = ::g::Uno::Collections::List__Enumerator_typeof()->MakeType(::TYPES[43/*Fuse.Node*/], NULL);
    ::TYPES[52] = ::g::Uno::Collections::ObservableList_typeof()->MakeType(::g::Uno::UX::Template_typeof(), NULL);
    ...
    type->SetFields(12,
        ...
        ::TYPES[42/*Uno.Collections.Dictionary<Fuse.Node, object>*/], offsetof(::g::Fuse::Reactive::Instantiator, _dataMap), 0,
        ...
        ::TYPES[41/*Uno.Collections.List<Uno.Collections.List<Fuse.Node>>*/], offsetof(::g::Fuse::Reactive::Instantiator, _nodes), 0,
...
void Instantiator__FuseNodeISubtreeDataProviderGetData_fn(Instantiator* __this, ::g::Fuse::Node* n, uObject** __retval)
{
    ...
    {
        Instantiator__ObservableLink* ol = uAs<Instantiator__ObservableLink*>(v, ::TYPES[44/*Fuse.Reactive.Instantiator.ObservableLink*/]);

        if (ol != NULL)
            return *__retval = uPtr(ol)->Data(), void();

        if (!uIs(v, ::TYPES[45/*Fuse.Reactive.Instantiator.CountItem*/]))
...
void Instantiator::ctor_3()
{
    ...
    _dataMap = ((::g::Uno::Collections::Dictionary*)::g::Uno::Collections::Dictionary::New1(::TYPES[42/*Uno.Collections.Dictionary<Fuse.Node, object>*/]));
    ctor_2();
}
...
{
    ::g::Fuse::Node* elm = uAs< ::g::Fuse::Node*>(uPtr(f)->New1(), ::TYPES[43/*Fuse.Node*/]);

    if (elm == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[41/*"Template co...*/], this, ::STRINGS[32/*"/Users/eric...*/], 1455, ::STRINGS[42/*"AddTemplate"*/]);
        return;
    }
...
uString* Instantiator::GetMatchKey(uObject* data)
{
    ...
    {
        if (::g::Fuse::IObject::ContainsKey(uInterface(uPtr(so), ::TYPES[46/*Fuse.IObject*/]), _matchKey))
            return uAs<uString*>(::g::Fuse::IObject::Item(uInterface(uPtr(so), ::TYPES[46/*Fuse.IObject*/]), _matchKey), ::TYPES[23/*string*/]);
    }
...
void Instantiator::InsertNew(int dataIndex)
{
    ...
    if (!anyMatched)
    {
        ...
        {
            ::g::Uno::UX::Template* f = (::g::Uno::Collections::IEnumerator1::get_Current_ex(uInterface(uPtr(enum2), ::TYPES[49/*Uno.Collections.IEnumerator<Uno.UX.Template>*/]), &ret11), ret11);
    ...
    uPtr(Parent())->InsertNodes((::g::Uno::Collections::EnumerableExtensions__IndexOf_fn(::TYPES[50/*Uno.Collections.EnumerableExtensions.IndexOf<Fuse.Node>*/], uPtr(Parent())->Children(), lastNode, &ret12), ret12) + 1, uBox(::TYPES[51/*Uno.Collections.List<Fuse.Node>.Enumerator*/], (::g::Uno::Collections::List__GetEnumerator_fn(newElements, &ret13), ret13)));
}
...
void Instantiator::Limit(int value)
{
    ...
    if (value < 0)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[43/*"Limit canno...*/], this, ::STRINGS[32/*"/Users/eric...*/], 1033, ::STRINGS[44/*"set_Limit"*/], NULL);
        value = 0;
    }
...
void Instantiator::Offset(int value)
{
    ...
    if (value < 0)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[45/*"Offset cann...*/], this, ::STRINGS[32/*"/Users/eric...*/], 985, ::STRINGS[46/*"set_Offset"*/], NULL);
        value = 0;
    }
...
void Instantiator::RemoveAt(int dataIndex)
{
    ...
    for (::g::Uno::Collections::List__Enumerator<uStrong< ::g::Fuse::Node*> > enum1 = (::g::Uno::Collections::List__GetEnumerator_fn(uPtr((::g::Uno::Collections::List__get_Item_fn(uPtr(_nodes), uCRef<int>(windowIndex), &ret17), ret17)), &ret16), ret16); enum1.MoveNext(::TYPES[51/*Uno.Collections.List<Fuse.Node>.Enumerator*/]); )
    {
        ::g::Fuse::Node* c = enum1.Current(::TYPES[51/*Uno.Collections.List<Fuse.Node>.Enumerator*/]);
...
uObject* Instantiator::Templates()
{
    ...
    return (ind3 != NULL) ? ind3 : (uObject*)(_templates = (uObject*)((::g::Uno::Collections::ObservableList*)::g::Uno::Collections::ObservableList::New1(::TYPES[52/*Uno.Collections.ObservableList<Uno.UX.Template>*/], uDelegate::New(::TYPES[53/*Uno.Action<Uno.UX.Template>*/], (void*)Instantiator__OnTemplatesChanged_fn, this), uDelegate::New(::TYPES[53/*Uno.Action<Uno.UX.Template>*/], (void*)Instantiator__OnTemplatesChanged_fn, this))));
}
...
static void JavaScript_build(uType* type)
{
    ...
    ::TYPES[29] = ::g::Uno::IDisposable_typeof();
    ::TYPES[13] = ::g::Uno::Action_typeof();
    ::TYPES[54] = ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Fuse::Scripting::NativeModule_typeof(), NULL);
    ::TYPES[55] = ::g::Uno::UX::Resource_typeof()->MakeMethod(0/*GetGlobalsOfType<Fuse.Scripting.NativeModule>*/, ::g::Fuse::Scripting::NativeModule_typeof(), NULL);
    ::TYPES[8] = ::g::Uno::Collections::IEnumerator_typeof();
    ::TYPES[56] = ::g::Uno::Collections::IEnumerator1_typeof()->MakeType(::g::Fuse::Scripting::NativeModule_typeof(), NULL);
    ::TYPES[31] = ::g::Fuse::Reactive::IObservable_typeof();
    type->SetInterfaces(
...
void JavaScript__OnUnrooted_fn(JavaScript* __this)
{
    ...
    if ((--JavaScript::_javaScriptCounter()) <= 0)
    {
        ...
        for (uObject* enum1 = (uObject*)::g::Uno::Collections::IEnumerable::GetEnumerator(uInterface(uPtr((uObject*)::g::Uno::UX::Resource::GetGlobalsOfType(::TYPES[55/*Uno.UX.Resource.GetGlobalsOfType<Fuse.Scripting.NativeModule>*/])), ::TYPES[54/*Uno.Collections.IEnumerable<Fuse.Scripting.NativeModule>*/])); ::g::Uno::Collections::IEnumerator::MoveNext(uInterface(uPtr(enum1), ::TYPES[8/*Uno.Collections.IEnumerator*/])); )
        {
...
void JavaScript::EvaluateModule()
{
...

    {
        ...
        if (newModuleResult->Error() == NULL)
        {
            ...
            {
                ::g::Fuse::Diagnostics::UserSuccess(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[48/*"JavaScript ...*/], FileName()), ::STRINGS[49/*" fixed!"*/]), this, ::STRINGS[5/*"/Users/eric...*/], 415, ::STRINGS[50/*"EvaluateMod...*/]);
        ...
        else
        {
            ...
            {
                JavaScript::UserScriptError(::STRINGS[51/*"JavaScript ...*/], se, this, ::STRINGS[5/*"/Users/eric...*/], 426, ::STRINGS[50/*"EvaluateMod...*/]);
...
static void ThreadWorker__MethodClosure_build(uType* type)
{
    ...
    ::TYPES[24] = ::g::Fuse::Scripting::Function_typeof();
    ::TYPES[26] = ::g::Fuse::Scripting::Callback_typeof();
    ::TYPES[57] = ::g::Fuse::Scripting::External_typeof();
    ::TYPES[25] = ::g::Fuse::Scripting::Array_typeof();
    type->SetFields(0,
...
{
    uObject* self = uPtr(uCast< ::g::Fuse::Scripting::External*>(uPtr(args)->Strong<uObject*>(0), ::TYPES[57/*Fuse.Scripting.External*/]))->Object;
...
{
    ::TYPES[58] = ::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable_typeof()->MakeType(uObject_typeof(), NULL);
    ::TYPES[0] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Reactive::Observable__Subscription_typeof(), NULL);
    ::TYPES[1] = ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Reactive::Observable__Subscription_typeof(), NULL);
    ::TYPES[2] = ::g::Fuse::Reactive::IObserver_typeof();
    type->SetFields(2,
...
void Observable__NewAll__OnPerform_fn(Observable__NewAll* __this, uObject* sub)
{
    ...
    uPtr(__this->Observable())->UnsubscribeValues();
    uPtr(uPtr(__this->Observable())->_values)->Clear();
    uPtr(uPtr(__this->Observable())->_values)->AddRange((uObject*)((::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable*)::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable::New1(::TYPES[58/*Uno.Runtime.Implementation.Internal.ArrayEnumerable<object>*/], uPtr(__this->_newValues)->ItemsReadonly())));
...
{
    ::TYPES[59] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Uno::String_typeof(), uObject_typeof(), NULL);
    ::TYPES[60] = ::g::Uno::Collections::Dictionary__Enumerator_typeof()->MakeType(::g::Uno::String_typeof(), uObject_typeof(), NULL);
    ::TYPES[4] = ::g::Fuse::Reactive::ValueMirror_typeof();
    ::TYPES[10] = ::g::Uno::Collections::KeyValuePair_typeof()->MakeType(::g::Uno::String_typeof(), uObject_typeof(), NULL);
    ::TYPES[61] = ::g::Uno::Collections::EnumerableExtensions_typeof()->MakeMethod(7/*ToArray<string>*/, ::g::Uno::String_typeof(), NULL);
    type->SetInterfaces(
        ::g::Fuse::IRaw_typeof(), offsetof(ObjectMirror_type, interface0),
        ::g::Fuse::IObject_typeof(), offsetof(ObjectMirror_type, interface1));
    type->SetFields(1,
        ::TYPES[59/*Uno.Collections.Dictionary<string, object>*/], offsetof(::g::Fuse::Reactive::ObjectMirror, _props), 0);
}
...
void ObjectMirror__Unsubscribe_fn(ObjectMirror* __this)
{
    ...
    for (::g::Uno::Collections::Dictionary__Enumerator<uStrong<uString*>, uStrong<uObject*> > enum1 = (::g::Uno::Collections::Dictionary__GetEnumerator_fn(uPtr(__this->_props), &ret4), ret4); enum1.MoveNext(::TYPES[60/*Uno.Collections.Dictionary<string, object>.Enumerator*/]); )
    {
        ::g::Uno::Collections::KeyValuePair<uStrong<uString*>, uStrong<uObject*> > p = enum1.Current(::TYPES[60/*Uno.Collections.Dictionary<string, object>.Enumerator*/]);
...
{
    _props = ((::g::Uno::Collections::Dictionary*)::g::Uno::Collections::Dictionary::New1(::TYPES[59/*Uno.Collections.Dictionary<string, object>*/]));
    ctor_(obj);
...
{
    return (uArray*)::g::Uno::Collections::EnumerableExtensions::ToArray(::TYPES[61/*Uno.Collections.EnumerableExtensions.ToArray<string>*/], (uObject*)((::g::Uno::Collections::Dictionary__KeyCollection*)uPtr(_props)->Keys()));
}
...
static void Observable_build(uType* type)
{
    ...
    ::TYPES[63] = ::g::Uno::Collections::List_typeof()->MakeType(Observable__Subscription_typeof(), NULL);
    ::TYPES[26] = ::g::Fuse::Scripting::Callback_typeof();
    ::TYPES[3] = uObject_typeof()->Array();
    ::TYPES[15] = ::g::Fuse::Scripting::Object_typeof();
    ::TYPES[23] = ::g::Uno::String_typeof();
    ::TYPES[64] = ::g::Fuse::Reactive::ArrayMirror_typeof();
    ::TYPES[19] = ::g::Uno::Int_typeof();
    ::TYPES[21] = ::g::Uno::Double_typeof();
    ::TYPES[13] = ::g::Uno::Action_typeof();
    ::TYPES[4] = ::g::Fuse::Reactive::ValueMirror_typeof();
    ...
    type->SetFields(1,
        ...
        ::TYPES[63/*Uno.Collections.List<Fuse.Reactive.Observable.Subscription>*/], offsetof(::g::Fuse::Reactive::Observable, _observers), 0,
        ::g::Uno::Bool_typeof(), offsetof(::g::Fuse::Reactive::Observable, _usingObservers), 0,
        ::TYPES[62/*Uno.Collections.List<object>*/], offsetof(::g::Fuse::Reactive::Observable, _values), 0,
...
{
    _values = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[62/*Uno.Collections.List<object>*/]));
    _observers = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[63/*Uno.Collections.List<Fuse.Reactive.Observable.Subscription>*/]));
    ctor_1(obj);
    _worker = worker;
    _observable = obj;
...
uObject* Observable::ObserveChange(uArray* args)
{
    ...
    if (::g::Uno::String::op_Equality(op, ::STRINGS[60/*"set"*/]))
        ...
        uPtr(_worker)->Enqueue(Observable__NewAll::New1(this, uCast< ::g::Fuse::Reactive::ArrayMirror*>(uPtr(_worker)->Reflect(uPtr(args)->Strong<uObject*>(3)), ::TYPES[64/*Fuse.Reactive.ArrayMirror*/]), origin));
        ...
        uPtr(_worker)->Enqueue(Observable__InsertAll::New1(this, ToInt(uPtr(args)->Strong<uObject*>(3)), uCast< ::g::Fuse::Reactive::ArrayMirror*>(uPtr(_worker)->Reflect(uPtr(args)->Strong<uObject*>(4)), ::TYPES[64/*Fuse.Reactive.ArrayMirror*/])));
...
static void ObservableProperty_build(uType* type)
{
    ...
    ::TYPES[29] = ::g::Uno::IDisposable_typeof();
    ::TYPES[13] = ::g::Uno::Action_typeof();
    ::TYPES[65] = ::g::Uno::Action1_typeof()->MakeType(uObject_typeof(), NULL);
    type->SetInterfaces(
...
void ObservableProperty__UnoUXIPropertyListenerOnPropertyChanged_fn(ObservableProperty* __this, ::g::Uno::UX::PropertyObject* obj, ::g::Uno::UX::Selector* prop)
{
    ...
    uPtr(__this->_worker)->Invoke(uDelegate::New(::TYPES[13/*Uno.Action*/], (void*)ObservableProperty__PushCapture__Run_fn, ObservableProperty__PushCapture::New1(uDelegate::New(::TYPES[65/*Uno.Action<object>*/], (void*)ObservableProperty__PushValue_fn, __this), uPtr(__this->_property)->GetAsObject1())));
}
...
{
    ::TYPES[66] = ::g::Uno::UX::PropertyObject_typeof();
    type->SetInterfaces(
        ::g::Fuse::Reactive::IExpression_typeof(), offsetof(::g::Fuse::Reactive::Expression_type, interface0));
    type->SetFields(0,
...
{
    ::g::Uno::UX::PropertyObject* obj = uCast< ::g::Uno::UX::PropertyObject*>(uPtr(__this->Object())->GetValue(context), ::TYPES[66/*Uno.UX.PropertyObject*/]);
...
{
    ::g::Uno::UX::PropertyObject* obj = uAs< ::g::Uno::UX::PropertyObject*>(::g::Fuse::Reactive::ThreadWorker::Wrap(uPtr(args)->Strong<uObject*>(0)), ::TYPES[66/*Uno.UX.PropertyObject*/]);
...
static void ResourceSubscription_build(uType* type)
{
    ...
    ::TYPES[13] = ::g::Uno::Action_typeof();
    ::TYPES[29] = ::g::Uno::IDisposable_typeof();
    ::TYPES[67] = ::g::Uno::Predicate_typeof()->MakeType(uObject_typeof(), NULL);
    ::TYPES[5] = ::g::Fuse::Reactive::IListener_typeof();
    type->SetInterfaces(
...
void ResourceSubscription::OnChanged()
{
    ...
    if (uPtr(uPtr(_origin)->Parent())->TryGetResource(_key, uDelegate::New(::TYPES[67/*Uno.Predicate<object>*/], (void*)ResourceSubscription__Accept_fn, this), &resource))
...
static void RootableScriptModule_build(uType* type)
{
    ...
    ::TYPES[68] = ::g::Uno::Collections::ICollection_typeof()->MakeType(uObject_typeof(), NULL);
...
void RootableScriptModule__GenerateArgs_fn(RootableScriptModule* __this, ::g::Fuse::Scripting::Context* c, ::g::Fuse::Scripting::ModuleResult* result, ::g::Uno::Collections::List* args, uString** __retval)
{
    ...
    int o = (nt != NULL) ? ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(uPtr(nt)->Objects()), ::TYPES[68/*Uno.Collections.ICollection<object>*/])) - 1 : 0;
...
void Observable__Subscription::SetExclusive(uObject* newValue)
{
    ...
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[89/*"Unexpected ...*/], this, ::STRINGS[5/*"/Users/eric...*/], 607, ::STRINGS[90/*"SetExclusive"*/]);
        return;
    }
    ...
    catch (const uThrowable& __t)
    {
        ...
        {
            ::g::Fuse::Scripting::ScriptException* ex = (::g::Fuse::Scripting::ScriptException*)__t.Exception;
            ::g::Fuse::Reactive::JavaScript::UserScriptError(::STRINGS[92/*"Failed to s...*/], ex, this, ::STRINGS[5/*"/Users/eric...*/], 619, ::STRINGS[90/*"SetExclusive"*/]);
        }
        else throw __t;
    }
}
...
void ThreadWorker::CheckAndThrow()
{
    ...
    {
        if (prev != NULL)
            ::g::Fuse::Diagnostics::UnknownException(::STRINGS[95/*"Skipped Exc...*/], next, this, ::STRINGS[5/*"/Users/eric...*/], 1820, ::STRINGS[96/*"CheckAndThrow"*/]);
...
uObject* ThreadWorker::CreateMirror(uObject* obj)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserWarning(::STRINGS[97/*"JavaScript ...*/], this, ::STRINGS[5/*"/Users/eric...*/], 1390, ::STRINGS[98/*"CreateMirror"*/]);
        return NULL;
    }
...
{
    ::g::Fuse::Scripting::External* e = uAs< ::g::Fuse::Scripting::External*>(obj, ::TYPES[57/*Fuse.Scripting.External*/]);
    ...
    if (sobj != NULL)
    {
        ...
        {
            ::g::Fuse::Scripting::External* ext = uAs< ::g::Fuse::Scripting::External*>(uPtr(sobj)->Item(::STRINGS[101/*"external_ob...*/]), ::TYPES[57/*Fuse.Scripting.External*/]);
...
void ThreadWorker::Run()
{
    ...
    {
        ::g::Uno::Exception* e = __t.Exception;
        ::g::Fuse::Diagnostics::UnknownException(::STRINGS[109/*"ThreadWorke...*/], e, this, ::STRINGS[5/*"/Users/eric...*/], 1716, ::STRINGS[110/*"Run"*/]);
...
uObject* ThreadWorker::Wrap(uObject* obj)
{
    ...
    if (uIs(obj, ::TYPES[57/*Fuse.Scripting.External*/]))
        return uPtr(uCast< ::g::Fuse::Scripting::External*>(obj, ::TYPES[57/*Fuse.Scripting.External*/]))->Object;
    ...
    if (uIs(obj, ::TYPES[90/*uint*/]))
        return uBox(::TYPES[21/*double*/], (double)uUnbox<uint32_t>(::TYPES[90/*uint*/], obj));
