...
void HttpImageSourceImpl::HttpCallback(::g::Experimental::Http::HttpResponseHeader* response, ::g::Uno::Buffer* data)
{
    ...
    {
        Fail(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::STRINGS[5/*"HttpImageSo...*/], uBox<int>(::TYPES[25/*int*/], uPtr(response)->StatusCode())), ::STRINGS[6/*" "*/]), uPtr(response)->ReasonPhrase()), NULL);
        return;
    }
...
{
    bool q = (uIs(o, ::TYPES[24/*float*/]) || uIs(o, ::TYPES[25/*int*/])) || uIs(o, ::TYPES[26/*double*/]);
    return q;
}
...
{
    if (uIs(o, ::TYPES[24/*float*/]))
        return (double)uUnbox<float>(::TYPES[24/*float*/], o);

    if (uIs(o, ::TYPES[26/*double*/]))
        return uUnbox<double>(::TYPES[26/*double*/], o);

    if (uIs(o, ::TYPES[25/*int*/]))
        return (double)uUnbox<int>(::TYPES[25/*int*/], o);
...
static void ResourceBinding_build(uType* type)
{
    ...
    type->SetFields(1,
        ::TYPES[30/*Fuse.Resources.IResourceConverter`1*/]->MakeType(type->T(0), NULL), offsetof(::g::Fuse::Resources::ResourceBinding, _converter), 0,
...
{
    ::TYPES[32] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Uno::Type_typeof(), uObject_typeof(), NULL);
    ::TYPES[33] = ::g::Uno::Type_typeof();
    ::TYPES[34] = ::g::Fuse::Resources::GenericResourceConverter_typeof();
    type->MethodTypes[0]->SetPrecalc(
        ::TYPES[34/*Fuse.Resources.GenericResourceConverter`1*/]->MakeType(type->MethodTypes[0]->U(0), NULL));
    type->SetFields(0,
        ::TYPES[32/*Uno.Collections.Dictionary<Uno.Type, object>*/], (uintptr_t)&::g::Fuse::Resources::ResourceConverters::_converters_, uFieldFlagsStatic);
}
...
uObject* ResourceConverters::Get(uType* __type)
{
    ...
    {
        if (::g::Uno::Type::op_Equality(__type->U(0), ::TYPES[24/*float*/]))
            converter = ::g::Fuse::Resources::FloatResourceConverter::New1();
        else if (::g::Uno::Type::op_Equality(__type->U(0), ::TYPES[26/*double*/]))
            converter = ::g::Fuse::Resources::DoubleResourceConverter::New1();
        else if (::g::Uno::Type::op_Equality(__type->U(0), ::TYPES[25/*int*/]))
...
{
    ::TYPES[35] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Uno::String_typeof(), ::g::Uno::Collections::List_typeof()->MakeType(::g::Uno::Action_typeof(), NULL), NULL);
    ::TYPES[36] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Uno::Action_typeof(), NULL);
    ::TYPES[37] = ::g::Uno::Collections::List__Enumerator_typeof()->MakeType(::g::Uno::Action_typeof(), NULL);
    type->SetFields(0,
        ::TYPES[35/*Uno.Collections.Dictionary<string, Uno.Collections.List<Uno.Action>>*/], (uintptr_t)&::g::Fuse::Resources::ResourceRegistry::_handlers_, uFieldFlagsStatic);
}
