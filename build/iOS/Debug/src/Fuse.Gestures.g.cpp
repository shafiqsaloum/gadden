...
// /Users/ericaglimsholt/Library/Application Support/Fusetools/Packages/Fuse.Gestures/0.47.7/$.uno
// -----------------------------------------------------------------------------------------------
...
// /Users/ericaglimsholt/Library/Application Support/Fusetools/Packages/Fuse.Gestures/0.47.7/internal/$.uno
// --------------------------------------------------------------------------------------------------------
...
static void KeepInViewCommon_build(uType* type)
{
    ...
    type->SetFields(12,
        ...
        ::TYPES[9/*Fuse.Elements.Element*/], offsetof(::g::Fuse::Gestures::KeepInViewCommon, _rootElement), 0,
        ::TYPES[9/*Fuse.Elements.Element*/], offsetof(::g::Fuse::Gestures::KeepInViewCommon, _target), 0);
}
...
static void Scroller_build(uType* type)
{
    ...
    ::STRINGS[2] = uString::Const("/Users/ericaglimsholt/Library/Application Support/Fusetools/Packages/Fuse.Controls.ScrollView/0.47.7/$.uno");
    ...
    ::TYPES[11] = ::g::Fuse::Motion::Simulation::PointerVelocity_typeof()->MakeType(::g::Uno::Float2_typeof(), NULL);
    ::TYPES[12] = ::g::Fuse::Motion::Simulation::Simulation_typeof();
    ::TYPES[13] = ::g::Fuse::Motion::Simulation::BoundedRegion2D_typeof();
    ::TYPES[2] = ::g::Uno::Action_typeof();
    ::TYPES[14] = ::g::Fuse::Motion::Simulation::MotionSimulation_typeof()->MakeType(::g::Uno::Float2_typeof(), NULL);
    ::TYPES[15] = ::g::Fuse::Controls::ScrollView_typeof();
    ::TYPES[16] = ::g::Fuse::RequestBringIntoViewHandler_typeof();
    ::TYPES[17] = ::g::Fuse::Controls::ScrollPositionChangedHandler_typeof();
    type->SetInterfaces(
    ...
    type->SetFields(12,
        ...
        ::TYPES[13/*Fuse.Motion.Simulation.BoundedRegion2D*/], offsetof(::g::Fuse::Gestures::Scroller, _region), 0,
        ::TYPES[15/*Fuse.Controls.ScrollView*/], offsetof(::g::Fuse::Gestures::Scroller, _scrollable), 0,
        ...
        ::TYPES[11/*Fuse.Motion.Simulation.PointerVelocity<float2>*/], offsetof(::g::Fuse::Gestures::Scroller, _velocity), 0,
...
void Scroller__FuseInputIGestureOnCapture_fn(Scroller* __this, ::g::Fuse::Input::PointerEventArgs* args, int* how)
{
    ...
    ::g::Fuse::Motion::Simulation::BoundedRegion2D::StartUser(uInterface(uPtr(__this->_region), ::TYPES[13/*Fuse.Motion.Simulation.BoundedRegion2D*/]));
    ::g::Fuse::Motion::Simulation::MotionSimulation::set_Position_ex(uInterface(uPtr(__this->_region), ::TYPES[14/*Fuse.Motion.Simulation.MotionSimulation<float2>*/]), uCRef(uPtr(__this->_scrollable)->ScrollPosition()));
...
{
    if (::g::Fuse::Motion::Simulation::BoundedRegion2D::IsUser(uInterface(uPtr(__this->_region), ::TYPES[13/*Fuse.Motion.Simulation.BoundedRegion2D*/])))
        ::g::Fuse::Motion::Simulation::BoundedRegion2D::EndUser(uInterface(uPtr(__this->_region), ::TYPES[13/*Fuse.Motion.Simulation.BoundedRegion2D*/]), ::g::Uno::Float2__New1(0.0f));
...
{
    ::g::Uno::Float2 ret2;
    return *__retval = (::g::Uno::Vector::Length((::g::Fuse::Motion::Simulation::MotionSimulation::get_Velocity_ex(uInterface(uPtr(__this->_region), ::TYPES[14/*Fuse.Motion.Simulation.MotionSimulation<float2>*/]), &ret2), ret2)) > 100.0f) ? 3 : 2, void();
}
...
void Scroller__FuseInputIGestureOnPointerReleased_fn(Scroller* __this, ::g::Fuse::Input::PointerReleasedArgs* args, int* __retval)
{
    ...
    if (::g::Fuse::Motion::Simulation::BoundedRegion2D::IsUser(uInterface(uPtr(__this->_region), ::TYPES[13/*Fuse.Motion.Simulation.BoundedRegion2D*/])))
    {
        ...
        ::g::Fuse::Motion::Simulation::BoundedRegion2D::EndUser(uInterface(uPtr(__this->_region), ::TYPES[13/*Fuse.Motion.Simulation.BoundedRegion2D*/]), ::g::Uno::Float2__op_UnaryNegation(uPtr(__this->_scrollable)->ConstrainExtents((::g::Fuse::Motion::Simulation::PointerVelocity__get_CurrentVelocity_fn(uPtr(__this->_velocity), &ret3), ret3))));
    }
...
void Scroller__OnRooted_fn(Scroller* __this)
{
    ...
    uPtr(__this->_scrollable)->add_ScrollPositionChanged(uDelegate::New(::TYPES[17/*Fuse.Controls.ScrollPositionChangedHandler*/], (void*)Scroller__OnScrollPositionChanged_fn, __this));
...
void Scroller__OnUnrooted_fn(Scroller* __this)
{
    ...
    uPtr(__this->_scrollable)->remove_ScrollPositionChanged(uDelegate::New(::TYPES[17/*Fuse.Controls.ScrollPositionChangedHandler*/], (void*)Scroller__OnScrollPositionChanged_fn, __this));
...
void Scroller::CheckLimits()
{
    ...
    if (((_region != NULL) && ::g::Fuse::Motion::Simulation::Simulation::IsStatic(uInterface(uPtr(_region), ::TYPES[12/*Fuse.Motion.Simulation.Simulation*/]))) && !::g::Fuse::Motion::Simulation::BoundedRegion2D::IsUser(uInterface(uPtr(_region), ::TYPES[13/*Fuse.Motion.Simulation.BoundedRegion2D*/])))
...
{
    bool needUpdated = ((_region != NULL) && !::g::Fuse::Motion::Simulation::Simulation::IsStatic(uInterface(uPtr(_region), ::TYPES[12/*Fuse.Motion.Simulation.Simulation*/]))) && IsRootingStarted();
...
void Scroller::Goto(::g::Uno::Float2 position)
{
    ...
    if (_region != NULL)
    {
        if (::g::Fuse::Motion::Simulation::Simulation::IsStatic(uInterface(uPtr(_region), ::TYPES[12/*Fuse.Motion.Simulation.Simulation*/])))
            ::g::Fuse::Motion::Simulation::MotionSimulation::set_Position_ex(uInterface(uPtr(_region), ::TYPES[14/*Fuse.Motion.Simulation.MotionSimulation<float2>*/]), uCRef(uPtr(_scrollable)->ScrollPosition()));
...
void Scroller::OnScrollPositionChanged(uObject* s, ::g::Fuse::Controls::ScrollPositionChangedArgs* args)
{
    ...
    if (uPtr(args)->IsAdjustment() && ::g::Uno::Float2__op_Inequality(uPtr(args)->ArrangeOffset(), ::g::Uno::Float2__New1(0.0f)))
        ::g::Fuse::Motion::Simulation::MotionSimulation::set_Position_ex(uInterface(uPtr(_region), ::TYPES[14/*Fuse.Motion.Simulation.MotionSimulation<float2>*/]), uCRef(::g::Uno::Float2__op_Addition2((::g::Fuse::Motion::Simulation::MotionSimulation::get_Position_ex(uInterface(uPtr(_region), ::TYPES[14/*Fuse.Motion.Simulation.MotionSimulation<float2>*/]), &ret4), ret4), uPtr(args)->ArrangeOffset())));
...
void Scroller::OnUpdated()
{
    ...
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[1/*"Invalid scr...*/], NULL, ::STRINGS[2/*"/Users/eric...*/], 435, ::STRINGS[3/*"OnUpdated"*/]);
        return;
    }
    ...
    uPtr(_scrollable)->SetScrollPosition1((::g::Fuse::Motion::Simulation::MotionSimulation::get_Position_ex(uInterface(uPtr(_region), ::TYPES[14/*Fuse.Motion.Simulation.MotionSimulation<float2>*/]), &ret6), ret6), (uObject*)this);
    CheckNeedUpdated(true);
}
...
void Scroller::UpdatePointerEvents(bool forceOff)
{
    ...
    {
        if (_gesture != NULL)
            ::g::Fuse::Diagnostics::InternalError(::STRINGS[4/*"inconsisten...*/], NULL, ::STRINGS[2/*"/Users/eric...*/], 218, ::STRINGS[5/*"UpdatePoint...*/]);
        else
    ...
    {
        if (_gesture == NULL)
            ::g::Fuse::Diagnostics::InternalError(::STRINGS[4/*"inconsisten...*/], NULL, ::STRINGS[2/*"/Users/eric...*/], 225, ::STRINGS[5/*"UpdatePoint...*/]);
        else
        {
...
{
    ::TYPES[18] = ::g::Uno::Action2_typeof()->MakeType(::g::Uno::Bool_typeof(), ::g::Uno::Bool_typeof(), NULL);
    type->SetInterfaces(
        ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Binding_typeof(), NULL), offsetof(::g::Fuse::Triggers::Trigger_type, interface0),
        ::g::Fuse::Scripting::IScriptObject_typeof(), offsetof(::g::Fuse::Triggers::Trigger_type, interface1),
        ::g::Fuse::IProperties_typeof(), offsetof(::g::Fuse::Triggers::Trigger_type, interface2),
...
void Swiped__OnRooted_fn(Swiped* __this)
{
    ...
    uPtr(__this->_region)->add_Swiped(uDelegate::New(::TYPES[18/*Uno.Action<bool, bool>*/], (void*)Swiped__OnSwiped_fn, __this));
}
...
{
    uPtr(__this->_region)->remove_Swiped(uDelegate::New(::TYPES[18/*Uno.Action<bool, bool>*/], (void*)Swiped__OnSwiped_fn, __this));
    ::g::Fuse::Triggers::Trigger__OnUnrooted_fn(__this);
}
...
static void SwipeGesture_build(uType* type)
{
    ...
    ::STRINGS[9] = uString::Const("/Users/ericaglimsholt/Library/Application Support/Fusetools/Packages/Fuse.Gestures/0.47.7/$.uno");
...
void SwipeGesture__OnRooted_fn(SwipeGesture* __this)
{
    ...
    if (element == NULL)
    {
        ::g::Fuse::Diagnostics::UserRootError(::STRINGS[8/*"Element"*/], __this->Parent(), __this, ::STRINGS[9/*"/Users/eric...*/], 1126, ::STRINGS[10/*"OnRooted"*/]);
        return;
    }
...
static void Tapped_build(uType* type)
{
    ...
    type->SetInterfaces(
        ...
        ::g::Fuse::Animations::IBasePlayerFeedback_typeof(), offsetof(::g::Fuse::Triggers::Trigger_type, interface7));
    type->SetFields(29,
        ::TYPES[19/*Fuse.Gestures.TappedHandler*/], offsetof(::g::Fuse::Gestures::Tapped, Handler1), 0);
}
...
{
    Handler1 = uCast<uDelegate*>(::g::Uno::Delegate::Combine(Handler1, value), ::TYPES[19/*Fuse.Gestures.TappedHandler*/]);
}
...
{
    Handler1 = uCast<uDelegate*>(::g::Uno::Delegate::Remove(Handler1, value), ::TYPES[19/*Fuse.Gestures.TappedHandler*/]);
}
