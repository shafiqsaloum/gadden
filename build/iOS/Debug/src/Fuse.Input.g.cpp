...
bool Pointer::ModifyCapture1(uObject* identity, ::g::Fuse::Visual* visual, uDelegate* lostCallback, int type, int pointIndex)
{
    ...
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[14/*"Capture can...*/], NULL, ::STRINGS[6/*"/Users/eric...*/], 1323, ::STRINGS[15/*"ModifyCapture"*/]);
        return false;
    }
...
{
    ::TYPES[30] = ::g::Fuse::HitTestCallback_typeof();
    type->SetFields(0,
...
{
    ::g::Fuse::HitTestContext* args = ::g::Fuse::HitTestContext::New1(point, uDelegate::New(::TYPES[30/*Fuse.HitTestCallback*/], (void*)SelectionQuery__Select_fn, this));
