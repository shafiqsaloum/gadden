// This file was generated based on /Users/ericaglimsholt/Documents/Skola/Handelsmarketing/Gadden/gadden/build/iOS/Preview1/cache/ux11/TabSponsor.g.uno.
...
static void TabSponsor_build(uType* type)
{
    ...
    type->SetFields(105,
        ::g::Uno::UX::NameTable_typeof(), offsetof(::g::TabSponsor, __g_nametable1), 0,
        ::g::Uno::String_typeof(), offsetof(::g::TabSponsor, _field_Text), 0,
        ::g::Uno::UX::Property1_typeof()->MakeType(::g::Uno::String_typeof(), NULL), offsetof(::g::TabSponsor, temp_Value_inst), 0,
        ::g::Uno::UX::Property1_typeof()->MakeType(::g::Uno::String_typeof(), NULL), offsetof(::g::TabSponsor, this_Text_inst), 0,
    ...
    type->Reflection.SetFunctions(4,
        new uFunction(".ctor", NULL, (void*)TabSponsor__New4_fn, 0, true, type, 0),
        new uFunction("SetText", NULL, (void*)TabSponsor__SetText_fn, 0, false, uVoid_typeof(), 2, ::g::Uno::String_typeof(), ::g::Uno::UX::IPropertyListener_typeof()),
        new uFunction("get_Text", NULL, (void*)TabSponsor__get_Text_fn, 0, false, ::g::Uno::String_typeof(), 0),
        new uFunction("set_Text", NULL, (void*)TabSponsor__set_Text_fn, 0, false, uVoid_typeof(), 1, ::g::Uno::String_typeof()));
}
...
::g::Fuse::Controls::Panel_type* TabSponsor_typeof()
{
    ...
    type = (::g::Fuse::Controls::Panel_type*)uClassType::New("TabSponsor", options);
...
// public TabSponsor New() :28
void TabSponsor__New4_fn(TabSponsor** __retval)
{
    *__retval = TabSponsor::New4();
}
...
// public TabSponsor() [instance] :28
void TabSponsor::ctor_7()
{
    uStackFrame __("TabSponsor", ".ctor()");
    ctor_6();
    InitializeUX();
}

// private void InitializeUX() [instance] :32
void TabSponsor::InitializeUX()
{
    uStackFrame __("TabSponsor", "InitializeUX()");
    ::g::Fuse::Reactive::This* temp1 = ::g::Fuse::Reactive::This::New1();
    ::g::Fuse::Controls::Text* temp = ::g::Fuse::Controls::Text::New3();
    temp_Value_inst = ::g::gadden_FuseControlsTextControl_Value_Property::New1(temp, TabSponsor::__selector0());
    ::g::Fuse::Reactive::Property* temp2 = ::g::Fuse::Reactive::Property::New1(temp1, ::g::gadden_accessor_TabSponsor_Text::Singleton());
    this_Text_inst = ::g::gadden_TabSponsor_Text_Property::New1(this, TabSponsor::__selector1());
    __g_nametable1 = ::g::Uno::UX::NameTable::New1(NULL, TabSponsor::__g_static_nametable1());
...
{
    uStackFrame __("TabSponsor", "SetText(string,Uno.UX.IPropertyListener)");
...
{
    uStackFrame __("TabSponsor", "set_Text(string)");
    SetText(value, NULL);
}

// public TabSponsor New() [static] :28
TabSponsor* TabSponsor::New4()
{
    TabSponsor* obj1 = (TabSponsor*)uNew(TabSponsor_typeof());
    obj1->ctor_7();
    return obj1;
}
// }
